...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [DrapfoldWife getCurrentScreenFrame].size.width, [DrapfoldWife getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
