...
#import "ParvfactionSpond.h"

/**
   not everyone is going to  
**/
@interface ParvfactionSpond()
...
**/
@implementation ParvfactionSpond
{
...
**/
    ...
    loginTabBtn = [NaturetyYoung initBtnWithTitleText_MMMethodMMM:@"text_login".localx fontSize_MMMethodMMM:FS(24) textColor_MMMethodMMM:UIColor.whiteColor tag_MMMethodMMM:kLoginTabActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
**/
    ...
    regTabBtn = [NaturetyYoung initBtnWithTitleText_MMMethodMMM:@"text_register".localx fontSize_MMMethodMMM:FS(24) textColor_MMMethodMMM:UIColor.whiteColor tag_MMMethodMMM:kRegTabActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
**/
    ...
    backBtn = [NaturetyYoung initBtnWithNormalImage_MMMethodMMM:mw_back_icon highlightedImage_MMMethodMMM:mw_back_icon tag_MMMethodMMM:kBackBtnActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
**/
    ...
    self.mAccountLoginView = [[MylingSeverform alloc] initView_MMMethodMMM];
...
//当警察把集市关起时
    ...
    self.mRegisterAccountView = [[TaurGeoile alloc] initView_MMMethodMMM];
