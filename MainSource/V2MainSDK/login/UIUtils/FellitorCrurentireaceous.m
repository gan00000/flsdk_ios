...
@implementation FellitorCrurentireaceous
+ (UIButton *)initBtnWithType_MMMethodMMM:(BUTTON_TYPE)type

/**
  urself up for a productive tomorrow."
...
//失眠。这样一来，床就不再是你安眠的舒适窝，而成为你辗转反侧心生焦虑并在疲惫中醒来的地方。
//
...
{
//e weren’t friends, not that I didn’t wanna be.
...
//图片
//
// 《Flightless Bird, American Mouth》是由Iron & Wine乐队演唱的一首独立民谣,Iron & Wine 这个一个人的乐队，却用让人赞叹的旋律和歌词
...
One way to make pursuing a goal that normally feels like a chore more fun is to combine it with a guilty pleasur 
**/
...
Why is that so important? Because lying in bed awake can 
**/
            break;
...
我只是说如果我们不是朋友会好很多，但是那不代表我不想和你交朋友。
He unleashed the full, devastating power of his eyes on me, as if trying to communicate something cruc 
**/
...
Though barriers may sometimes stand in the way of your dreams, remember that your destiny is hiding behind them. Accept the fact that not everyone is going to approve of the choices you’ve made, have faith in your judgment, catch the star that twinkles in your 
**/
        ...
        case BUTTON_TYPE_ACCOUNT_REGISTER:
                   ...
                   titleText = @"註冊會員";
                   break;
//shift in thinking, but it's an important one, Grander added.
//
//格兰德纳补充道，或许这听起来只是想法上的一个小小改变，但却很重要。
//
//Most adults need between seven and eight hours of sleep to be fully rested, according to the US Ce
        case BUTTON_TYPE_OK:
            normalImage = @"sdk_btn_bg.png";
            highlightedImage = @"sdk_btn_bg.png";
            titleText = @"確   認";
...
/**
  he replied, “what if I do this?” He dropped it on the ground and started to grind it into the floor with his shoe. He picked i 
**/
            break;
...
//格兰德纳补充道，在床和睡眠之间建立正向联系还有益于你在被工作或旅游打乱作息的夜晚入眠。
//
//"Let's say you need to go to bed extra early," he said. "The bed now 
...
He proceeded to crumple the 20 dollar note up. He then asked, “Who still wants it?” Stil 
**/
            break;
...
//Wide on my plastic 
        ...
        case BUTTON_TYPE_BIND_ACCOUNT://綁定會員
            normalImage = @"sdk_btn_bg.png";
//ades of data," Grandner said. In fac
            highlightedImage = @"sdk_btn_bg.png";
            titleText = @"綁定會員";
            break;
        default:
...
//我对你的爱，至死不渝。
    UIButton *mButton = [NaturetyYoung initBtnWithTitleText_MMMethodMMM:titleText fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:tag selector:selector target_MMMethodMMM:target];
    [mButton.layer setCornerRadius:20.0f];
    return mButton;

/**
   longer. And in the end, that's what often matters most to achieving a New Year's resolution.
...
/**
  taying up late one Friday to watch an extra episode of "Succession." After that, your early-to-bed plans went out the window because "what the hell," you'd already failed.
