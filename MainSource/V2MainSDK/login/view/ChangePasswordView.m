...
You don't know how long I've waited for you. And so the lion fell in love with the la 
**/
...
我对你的爱 无人能及。
Love is letting someone become your greatest weakness ,then going all you can do to protect each other.
爱就是让对方成为自己最大的弱点，然后再用尽 
**/
{
    SDKTextFiledView *oldPwdSDKTextFiledView;

/**
  信自我的判断，追随那颗在你心中闪烁的明星，它会引领你踏上命运的征途。坚持不懈，你就能享受那些幸福时刻。
...
Spending time around high achievers can boost your own performance. If your New Year's resolution is to run 
**/
...
//ation: whether you enjoy the act of goal pursuit.
//
//在完成目标的过程中，大多数人都力求
        [self addSubview:mLoginTitleView];

/**
  f the night, if you've been awake for 20 or 30 minutes, get up and reset. Maybe you just need five minutes to get sleepy, or maybe an hour, but don't spend that time awake in bed."
...
// on nights where your schedule has to be erratic due to work or travel, Grandner added.
//
...
/**
  ht to how I would die. But dying in the place of someone I love,seems like a good way to go.
...
花时间和高成就者在一起可以提高你自己的表现。如果你的新年愿望是跑一场马拉松或写一本书，那么明智的做法是开始与那些已经实现这一目标、可以告诉你如何做到的朋友们在一起。仅仅是和他们相处，你就会有收获，因为你会倾向于模仿他们的行为模 
**/
            make.leading.mas_equalTo(self).mas_offset(40);

/**
  hame, however, is putting cold hard c 
**/
...
When life offers you a dream so far beyon 
**/
        [againPwdSDKTextFiledView mas_makeConstraints:^(MASConstraintMaker *make) {
//ll catch the star that holds your destiny.
//
//
//
...
//我想你。我想念我在你身边醒来的所有早晨。
//
//I miss the way the sun shines at your face and the way t
            make.leading.mas_equalTo(oldPwdSDKTextFiledView);
            make.trailing.mas_equalTo(oldPwdSDKTextFiledView);
//ond.
//
...
//只是说如果我们不是朋友会好很多，但是那不代表我不想和你交朋友。
...
//寻找心中那颗闪耀的明星，因为只有你自己才能够让美好的梦想变成现实。满怀希望并全力以赴，你就能摘下改变命运的那颗星。
//
//I miss you. I miss all the mornings that I have wo
    }
    return self;
}
//ha latte during study sessions so there is a hook to get you to the library.
//
//想要把追求一个辛苦的目标变得更有趣，方法就是把它与有罪恶感的快乐结合起来。如果只允许
- (void)registerViewBtnAction_MMMethodMMM:(UIButton *)sender
{
    switch (sender.tag) {

/**
  ruly unique. The greatest gifts in life a 
**/
        case kOkActTag:
        {

/**
  oal that normally feels like a chore more fun is to combine it with a guilty pleasure. Consider only letting yourself watch your favorite TV show at the gym so you'll start looking forwar 
**/
            SDK_LOG(@"kOkActTag");
...
//thing they have to do in a jam-packed day, worth delaying to catch up on housework, schoolwork, office work or the latest binge-worthy television series.
//
//许多人将睡眠视为忙碌的一天后要做的最后一件事，为了完成家务、作业、工作或追新剧，晚点再睡也没事。
//
//That thinking needs to be ch
    if (![SdkUtil validUserName_MMMethodMMM:userName]) {
//是死在自己爱的人的怀里看起来是一个不错的选择。
...
//He unleashed the full, devastating power of his eyes on me, as if trying to commu
    ...
    if ([StringUtil isEmpty_MMMethodMMM:oldPwd]) {
        ...
        return;
//dner said. "Whether it's the beginning of the night or the middle of the night, if you've been awake
    }
    ...
    kWeakSelf
// shared goals can improve your success rate, too. Wh
...
//’d be better if we weren’t friends, not that I didn’t wanna be.
//我只是说如果我们不是朋友会好很多，但是那不代表我不想和你交朋友。
//He unleashed the full, devastating power of his eyes on me, as if tryin
        [SdkUtil toastMsg_MMMethodMMM:GetString(@"text_account_change_pwd_success")];
//n ever give somebody is get up -- don't lay in bed awake but not sleeping," Grandner said. "Whether it's the begi
...
Strangely enough, there is evidence that coaching friends with shared goals can improve your success rate, too. When you're on the hook to give someone else t 
**/
}
@end
