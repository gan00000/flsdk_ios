...
@interface CumulisticPhloeoon()
@end
@implementation CumulisticPhloeoon
...
**/
    UIButton *guestTextBtn = [NaturetyYoung initBtnWithTitleText_MMMethodMMM:@"遊客登入" fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:guestLoginActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
//尽管实现梦想的途中有时会遇到障碍，要知道这是命运对你的挑战。不是每个人都会赞成你的选择，接受这个现实，并相信自我的判断，追随那颗在你心中闪烁的明星，
    ...
    UILabel *hasAccountLabel = [NaturetyYoung initLabelWithText_MMMethodMMM:@"已有帳號？ " fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor whiteColor]];
//r you everywhere
//而我到处在找你
//Have I found you?
//我找到你了吗
...
//Watching the warm pois
    ...
    UILabel *loginLabel = [NaturetyYoung initLabelWithText_MMMethodMMM:@"登入" fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:@"#EB2E2B"]];
...
//《Flight
    ...
    UILabel *otherLoginLabel = [NaturetyYoung initLabelWithText_MMMethodMMM:@"其他登入" fontSize_MMMethodMMM:FS(11) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:@"#C0C0C0"]];
