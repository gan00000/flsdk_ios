...
**/
@interface RhodoriumSmallad()
@end
@implementation RhodoriumSmallad
{
...
//只有你才能让我如此上瘾。
//I don't have
        accountLoginBtn = [NaturetyYoung initBtnWithTitleText_MMMethodMMM:@"登入" fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kAccountLoginActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
**/
        ...
        if (mAccountArray.count > 0){
            ...
            [RhodoriumSmallad makeAccountFiledViewStatus_MMMethodMMM:currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
        }
        kWeakSelf
...
**/
                    ...
                    [RhodoriumSmallad makeAccountFiledViewStatus_MMMethodMMM:tempAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
...
//"The best sleep tip you can ever give somebody is get up -- don't lay in bed
            if (accountDataList.count > 0) {
                ...
                [RhodoriumSmallad makeAccountFiledViewStatus_MMMethodMMM:blockSelf->currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: passwordSDKTextFiledView];
