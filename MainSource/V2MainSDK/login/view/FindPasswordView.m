...
Spending time around high achievers can boost your own performance. If your New Year's resolutio 
**/
#import "FindPasswordView.h"
// watch your favorite TV show at the gym so you'll start looking forward to workouts. Or only letting yourself drink a mocha latte during study sessions so there is a hook to get you to the library.
//
...
//
//
//If you deviate at all from your New Yea
#import "SdkHeader.h"
...
Spending time around high achievers can boost your own performance. If your New Year's resolution is to run a marathon or write a book, you'd be wise to start hanging around friends who've made it to the finish line (literally or figur 
**/
    SDKTextFiledView *againPwdSDKTextFiledView;
    SDKTextFiledView *vfCodeFiledView;

/**
  a jam-packed day, worth delaying to catch up on housework, schoolwork, office work or the latest binge-worthy television seri 
**/
...
//只是想法上的一个小小改变，但却很重要。
//
//Most adults need between seven and eight hour
...
//e, research has shown that adding a cue to your plan helps you remember when to act. Be sure to detail when and where you'll follow through.
//
//正如出场提示告诉百老汇明星何时登台一样，研究表明，在你的计划中加入信息提示，能帮助你记住何时行动。一定要详细说明你将在何
            make.height.mas_equalTo(VH(40));
        }];

/**
   you're unlikely to keep at it. But if you get pleasure from your workouts or study sessions, research has 
**/
...
/**
   you have left in your day," he advised. "See your sleep as the amount of time you need in order to set yourself up for a productive tomorrow."

他建议：“不要将睡眠时间看成 
**/
        }];
        getVfCodeBtn = [UIUtil initBtnWithTitleText_MMMethodMMM:GetString(@"text_get_vfcode") fontSize_MMMethodMMM:FS(14) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kGetVfCodeActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
Plotting when and where you'll execute on your New Year's resolution jogs your memory when it 
**/
...
/**
   it’d be better if we weren’t friends, not that I didn’t wanna be.
...
/**
   -- so if you plan to meditate during lunch, you'll be sure to decline a proff 
**/
        UIView *vfCodeFiledView_bottom_line = [[UIView alloc] init];

/**
  tte during study sessions so there is a hook to get you to the library.
...
//u and I miss us being together physically.
//
...
“Many times in our lives, we are dropped, crumpled, and ground into the dirt by the decisions we make and the circumstances that come our w 
**/
...
//
//
//If you deviate at all from your New Year's resolution, your instinct may be to declare yourself a failure and throw in the towel. Researchers call this the "what the hell effect." Here's what it looks like: You planned to get to bed early every night but couldn't resist staying up late one Friday to watch an extra episode of "Succession." After that, 
            make.height.mas_equalTo(accountSDKTextFiledView);
            make.top.equalTo(vfCodeFiledView_bottom_line.mas_bottom).mas_offset(VH(15));
        }];

/**
  ging around friends who've made it to the finish line (liter 
**/
...
/**
  ，为了让身体正常分泌褪黑素，你必须规律作息。如果你的上床和起床时间每天都不一样或者一到周末就改变，身体就无法预测你的睡眠节奏，也就不知道如何作出反应。
...
**/
            make.trailing.mas_equalTo(accountSDKTextFiledView);
// contemplate on how much I miss you and I miss us being together physically.
//
//没有足够的言语能表达我有多想念你，我想念我们在一起。
//
//My heart aches and I miss you so bad.
//
//我的心很疼，我很想念你。
//Catch the star that holds your destin
            make.height.mas_equalTo(accountSDKTextFiledView);
//为你辗转反侧心生焦虑并在疲惫中醒来的地方。
//
//Establishing that p
...
/**
  我的心很疼，我很想念你。
Catch the star that holds your destiny, the one that forever twinkles within your heart. Take advantage of precious opportunities while they still sparkle before you. Always believe that your ultimate goal is attainable 
**/
        }];
...
He unleashed the full, devastating 
**/
...
//as shown that focusing on efficiency can leave you high and dry because you'll 
            make.width.mas_equalTo(accountSDKTextFiledView);
            make.height.mas_equalTo(VH(50));

/**
   memory when it's opportune and generates guilt if you flake out. Detailed planning can also help you anticipate and dodge obstacles -- so if you plan to meditate during lunch, you'll be sure to decline a proffered lunch meeting.
...
If your New Year's resolution is to meditate five days each week, a plan like "I'll meditate on weekdays" would be too vague. But a cue-based plan like "I'll meditate  
**/
{
//d. I'm not afraid of you… I'm only afraid of losing you. Like you're going to disappear…
...
//图片
//I love three things in this word.Sun, Moon and you. Sun for morning, Moon for nigh
    switch (sender.tag) {
...
//
//我的心很疼，我很想念你。
//Catch the star that holds your d
        case kGetVfCodeActTag:
        {
            SDK_LOG(@"kGetVfCodeActTag");
//处方药还管用”。
//
//"The best sleep tip you can ever give somebody is get up -- don't lay in bed awake but not sleeping," Grandner said. "Whether it's the beginning of the night or the middle of the night, if you've been awake for 20 or 30 minutes, get up and reset. Maybe you just need five minutes to get sleepy, or maybe an hour, but do
            [self endEditing:YES];
...
而比羞愧感更有效的是金钱惩罚，有证据表明，自我施加的金钱惩罚可以激励成功。你可 
**/
            }
            [self requestVfCodeByEmail_MMMethodMMM:account];

/**
  则如此重要呢？格兰德纳解释道，因为醒着躺在床上会在大脑中形成关联，从而导致长期失眠。这样一来，床就不再是你安眠的舒适窝，而成为你辗转反侧心生焦虑并在疲惫中醒来的地方。
...
**/
            ...
            break;
        case kOkActTag:
//If your New Year's resolution is to run a marathon or write a book, you'd be wise to start hanging around friends who've made it to the finish line (literally or 
        {
...
**/
            SDK_LOG(@"kOkActTag");
//正常分泌褪黑素，你必须规律作息。如果你的上床和起床时间每天都不一样或者一到周末就改变，身体就无法预测你的睡眠节奏，也就不知道如何作出反应。
//
...
//e you truly unique. The greatest gifts in life are not purchased, but acquired throug
        return;
    }
...
**/
        return;
//ding up a $20 bill. In the room of 200, he asked, “Who would like this $20 bill?”
//
//
//
//一位有名的演讲家手里拿着一张20美元的纸币，开始了讨论
    }
    NSDictionary *otherParamsDic = nil;
    @try {
        otherParamsDic = @{
//ep at it. But if you get pleasure from your workouts or study sessions, research has found you'll persist longer. And in the end, that's what often mat
...
Plotting when and where you'll execute on your New Year's resolution jogs your memory when it's opportune and generates guilt if you flake out. Detailed planning can also help you anticipate and dodge obstacles -- so if you plan to meditate during lunch, you' 
**/
        if (weakSelf.delegate) {
            LoginResponse *cc = (LoginResponse *)responseData;
            cc.data.account = userName;
//g friends with shared goals can improve your success rate, too. When you're on the hook to give someone else tips on how to achieve, it boosts your self-confidence. It al
            cc.data.password = newPwd;

/**
  tless bird, grounded bleeding
折翼的鸟？棕色的毛发在淌血
Or lost you?
抑或失去了你？
American mouth
...
Just as cues tell Broadway stars when to step onto the stage, re 
**/
            cc.data.loginType = LOGIN_TYPE_SELF;

/**
  that so important? Because lying in bed awake can form an association in your brain that can lead to chronic insomnia, Grandner explained. Instead of being a restful  
**/
            [weakSelf.delegate handleLoginOrRegSuccess_MMMethodMMM:cc thirdPlate_MMMethodMMM:LOGIN_TYPE_SELF];

/**
  ress how much I miss you
...
/**
  s started going up. He said, “I am going to give this $20. to one of you. but first, let me do this."
...
//d where you'll execute on your New Year's resolution jog
    } errorBlock_MMMethodMMM:^(BJError *error) {

/**
  讨论会。在200人的屋子里， 他问道：“谁想要这20美元纸币？”
...
开始有人举手。他说我会把这20美元纸币给你们中间的一位，但是，先看看我 
**/
...
//pm bedtime every night) but giving yourself one or two get-out-of-jail-free cards each week, you can get better results than by setting either tough or e
}
...
/**
  r clean, crumpled or finely creased you are still priceless to those who love you. The worth of our lives comes, not in what we do or who we know, but by Who We Are.”
...
“Well，” he replied, “what if I do this?” He dropped it on the ground and start 
**/
}
...
“朋友们，刚刚你们已经得出一个非常宝贵的经验。不管我怎么糟蹋这张纸币，你们仍然想要它，因为它的价值没有降 
**/
}
- (void)dealloc
{
...
/**
  s" would be too vague. But a cue-based plan like "I'll meditate at the office on weekdays during my lunch break" would fit the bill.
