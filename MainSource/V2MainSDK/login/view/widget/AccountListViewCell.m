...
Why is that so important? Because lying in bed awake can form an association in your brain that can lead to chronic insomnia, Grandner ex 
**/
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
       if (self) {

/**
  g to work in the morning and knowing that at the end of the day, 
**/
...
//for why this works is simple. Incentives change our decisions, and penalties are even more motivating than rewards
}
...
/**
   sleepy and when you wake up. As night approaches, levels of melatonin rise, becoming a signal to th 
**/
...
//sound like a small shift in thinking, but it's an important one, Gra
        make.bottom.mas_equalTo(self.contentView).offset(-2);

/**
  我会把这20美元纸币给你们中间的一位，但是，先看看我会这么做。”
...
//me true. Give your hopes everything you’ve got and you will catch the star th
...
/**
   within your heart. Take advantage of precious opportunities while they still sparkle before you. Always  
**/
...
/**
  ld like this $20 bill?”



一位有名的演讲家手里拿着一张20美元的纸币，开始了讨论会。在200人的屋子里， 他问道：“谁想要这20 
**/
...
//rt hanging around friends who've made it to the finish line (literally or figuratively) and can show you how it's done. You'll pick up a bit just by spending time together because you'll be inclined to conform to their patterns of behavior.
//
//花时间和
...
/**
   you can get better results than by setting either tough or easy goals without wiggle room, research has revealed.
...
Spending time around high achievers can boost your own 
**/
        make.height.width.mas_equalTo(VW(15));
//ess. If you want to ace a class, you assume long, distraction-free study sessions are key. But research has shown that focusing on efficiency can leave you hi
    }];
...
/**
  如果你从锻炼或学习中获得乐趣，就会坚持得更久。而最终，这往往是实现新年计划的最重要因素。
...
//w to achieve, it boosts your self-confidence. It also forces you to be introspective about what works in ways you might not otherwise.
//
...
//每天在固定时间起床和上床
//
//Melatonin is a hormone produced by the body to regulate when you get sleepy a
        _iconImageView.contentMode = UIViewContentModeScaleAspectFit;

/**
  兰德纳说，这是有“数十年数据”支持的一条睡眠医学黄金法则。事实上，这条法则在他的睡眠诊所中“甚至比处方药还管用”。

"The best sleep tip y 
**/
    }
//s believe that your ultimate goal is attainable as long as you commit yourself to it.
//
//
//
...
//esearch has found you'll persist longer. And in the end, that's what often matters most to achieving a New Year's resolution.
//
...
"Now you know when you have to stop and get ready to go to bed whether you're done or not," Grander said. "The problem is we don't stop, and we don't disconnect. And that's to our detriment and it makes the nex 
**/
    if (self.mItemViewClickHander) {
...
/**
  is evidence that coaching friends with shared goals can improve your su 
**/
}
@end
