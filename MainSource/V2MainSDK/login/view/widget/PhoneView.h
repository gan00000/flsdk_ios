...
/**
  ugh we are worthless；but no matter what happened or what will happen, you will never lose your value."
...
“Dirty or clean, crumpled or finely creased you are still priceless to those who love you. The worth of our lives comes, 
**/
#import "SDKBaseView.h"

/**
  ne a proffered lunch meeting.
...
This may sound sinister, but ensuring you'll face some penalty if you don't achieve your New Year's resolution can work wo 
**/
...
If you deviate at all from your New Year's resolution, your instinct may be to declare y 
**/
...
//
//It may sound like a small shift in thinking, but it's an important one, G
...
//
//"Let's say you need to go to bed extra early," he said. "The bed now has the power
...
/**
  ditate on weekdays" would be too vague. But a cue-based plan like "I'll meditate at the office on weekdays during my lunch break" would fit the bill.
