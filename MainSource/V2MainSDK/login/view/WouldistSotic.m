...
**/
        ...
        mLoginTitleView = [[SkillishAnyacious alloc] initViewWithTitle_MMMethodMMM:@"綁定會員帳號" hander_MMMethodMMM:^(NSInteger) {
        }];
...
//Bella, the only reason I left was because I thought I was protecting yo
        UIView *guestBindBtn = [[LexicofierBolery alloc] initBtnViewWithType_MMMethodMMM:(SDK_ICON_TITLE_BUTTON_TYPE_BIND_GEUST) tag_MMMethodMMM:kBindGuestActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
//当生活给了你一个远远超
            make.width.mas_equalTo(mLoginTitleView);
              ...
              UIView *fbBindBtn = [[LexicofierBolery alloc] initBtnViewWithType_MMMethodMMM:(SDK_ICON_TITLE_BUTTON_TYPE_BIND_FB) tag_MMMethodMMM:kBindFBActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        switch (sender.tag) {
            case kBindAppleActTag:
            {
                ...
                if (@available(iOS 13, *)) {
                     ...
                     [PepsitPostulo showAlertWithMessage_MMMethodMMM:GetString(@"GAMA_APPLE_SYSTEM_OLD_WARNING")];
                      return;
                  }
            }
                break;
