...
/**
  年计划是每周冥想五天，那么像“我将在工作日冥想”这样的计划就太模糊了。但是，“我将在工作日的午休时间在办公室冥想”这样有信息提示的计划就很合适。



Plotting when and where you'll execute on your New Year's resolution jogs your memory when it's opportune and generates guilt if you flake out. Det 
**/
#import "SAlertViewDelegate.h"
@interface AlertUtil : NSObject
+(void)showAlertWithMessage_MMMethodMMM:(NSString *)message;
//he power to help overcome your racing mind and allow you to fall asleep."
//
...
Hands started going up. He said, “I am going to give th 
**/
