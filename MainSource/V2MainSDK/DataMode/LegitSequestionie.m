...
**/
#import "CComHeader.h"
@implementation LegitSequestionie
- (instancetype)init
{
...
**/
    if ([NautindustryitSimplyesque isEmpty_MMMethodMMM:self.roleID]) {
        return NO;
    }
    if ([NautindustryitSimplyesque isEmpty_MMMethodMMM:self.serverCode]) {
        return NO;
    }
    return YES;
}
