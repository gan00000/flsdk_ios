...
**/
    OlivlingTricitic *configHTTPEngine = [[OlivlingTricitic alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/areaCode/areaInfo.json?t=%@", [DrapfoldWife getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
...
**/
        ...
        if (responseArray) {
//锻炼将能让你快速取得成效。如果你
            [ValueletTheatic savePhoneAreaInfo_MMMethodMMM:responseArray];
...
{
    OlivlingTricitic *configHTTPEngine = [[OlivlingTricitic alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/%@/v1/version.json?t=%@", GAME_CODE, [DrapfoldWife getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
...
**/
            ...
            if (mCr.subVersion){
                for (ConfigModel *cm in mCr.subVersion) {
                    if ([cm.version isEqualToString:[DrapfoldWife getBundleVersion_MMMethodMMM]] && [cm.packageName isEqualToString:[DrapfoldWife getBundleIdentifier_MMMethodMMM]]) {
                        SDK_DATA.mConfigModel = cm;
                        return;
                    }
                }
            }
            if (mCr.allVersion && [mCr.allVersion.packageName isEqualToString:[DrapfoldWife getBundleIdentifier_MMMethodMMM]]) {
...
//"Now you know when you have to stop and get ready to go to bed whether you're done or not," Grander said. "The problem is we don't stop, and we don't disconnect. And that's to our detriment and it 
    NSString * timeStamp=[DrapfoldWife getTimeStamp_MMMethodMMM];
...
**/
    OlivlingTricitic *logHTTPEngine = [[OlivlingTricitic alloc] initWithBasePath_MMMethodMMM:[SDKRES getLogUrl_MMMethodMMM]];
...
/**
  tant one, Grand 
**/
    NSString * md5SignStr=[DrapfoldWife getMD5StrFromString_MMMethodMMM:md5str];
    NSDictionary *dic = nil;
    @try {
        dic = @{
...
//I miss you. I m
    ...
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:requestUrlPath params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...
**/
            @"gameCode"         :[NSString stringWithFormat:@"%@",GAME_CODE],
            @"loginId"             :userName,
            @"password"              :[[DrapfoldWife getMD5StrFromString_MMMethodMMM:password] lowercaseString],
//锻炼将能让你快速取得成效。如果你想学好一门功课，你会认为长时间、不被打扰的学习很重要。但研究表明，专注于效率会让你被困在原地，因为你会忽略更重要的事：你是否享受追求目标的过程。
//
//
//
...
//It's a golden rule in sleep medicine, 
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_login_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
#pragma mark - 获取验证码
...
**/
    [params addEntriesFromDictionary:dic];
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_get_vfCode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
**/
    ...
    [params addEntriesFromDictionary:dic];
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_sendMobileVcode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
#pragma mark - 游戏内绑定手机
...
//格兰德纳补充道，在床和睡眠之间建立正向联系还有益于你在被工作或旅游
    ...
    [params addEntriesFromDictionary:dic];
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_bind_phone params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
#pragma mark - sdk基本参数
...
**/
        @"packageName"      :     [DrapfoldWife getBundleIdentifier_MMMethodMMM],
        @"adId"             :     [[DrapfoldWife getIdfa_MMMethodMMM]       lowercaseString]? : @"",
        @"idfa"             :     [[DrapfoldWife getIdfa_MMMethodMMM]       lowercaseString]? : @"",
//ichael Grandner. So if your bedtime and wake up 
        @"uuid"             :     [[DrapfoldWife getGamaUUID_MMMethodMMM]     lowercaseString]? : @"",
        @"versionName"      :     [DrapfoldWife getBundleShortVersionString_MMMethodMMM]? : @"",
        @"versionCode"      :     [DrapfoldWife getBundleVersion_MMMethodMMM]? : @"",
        @"systemVersion"    :     [DrapfoldWife getSystemVersion_MMMethodMMM]? : @"",
//上二三十分钟都睡不着，就起床调整一下。也许你只需要5分钟就能感觉到困意，也许需要一小时，但是这段时间不要醒着躺在床上。”
//
//Why is that so impo
        @"deviceType"       :     [DrapfoldWife getDeviceType_MMMethodMMM]? : @"",
        @"os"               :     @"ios",
...
**/
        @"osLanguage"       :     [DrapfoldWife getPreferredLanguage_MMMethodMMM]? : @"",

/**
  是让对方成为自己最大的弱点，然后再用尽全力守护彼此。
Is it not enough just to have a long and happy life with me 
**/
        @"uniqueId"         :     [[DrapfoldWife getGamaUUID_MMMethodMMM] lowercaseString]? : @"",
...
/**
  act. Be sure to d 
**/
        LegitSequestionie *gameUserModel = SDK_DATA.gameUserModel;
        NSDictionary *dic = @{
            @"gameCode"         :GAME_CODE,
...
**/
            @"password"         :[DrapfoldWife getMD5StrFromString_MMMethodMMM:password],
...
**/
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_login_register params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
**/
            @"oldPwd"           :[[DrapfoldWife getMD5StrFromString_MMMethodMMM:oldPassword] lowercaseString],
            @"newPwd"           :[[DrapfoldWife getMD5StrFromString_MMMethodMMM:newPassword] lowercaseString],
            @"registPlatform"   :LOGIN_TYPE_SELF,
...
**/
    ...
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_change_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...
**/
    ...
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_forgot_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...
**/
    ...
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_bind_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...
**/
    [BlackieNecrate postRequestWithFunctionPath_MMMethodMMM:api_delete_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
#pragma mark - 創單
+ (void)createOrderWithproductId_MMMethodMMM:(NSString *)productId
            cpOrderId_MMMethodMMM:(NSString *)cpOrderId
             ...
             gameInfo_MMMethodMMM:(LegitSequestionie*)gameUserModel
...
**/
    ...
    [SideNudation postRequestWithFunctionPath_MMMethodMMM:api_order_create params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...
**/
    ...
    [SideNudation postRequestWithFunctionPath_MMMethodMMM:api_payment params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
