...
- (NSString *)getMd5ResFileName_MMMethodMMM:(NSString *)originalName {
    ...
    NSString *md5EncryptFileName = [DrapfoldWife getMD5StrFromString_MMMethodMMM:textEncryptFileName];
...
- (NSString *)encryptContent_MMMethodMMM:(NSString *)textStringContent {
    ...
    //加密后的密文
    NSString *encryptStr = [TorquairDecisionful getEncryptStringFromString_MMMethodMMM:textStringContent WithKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return encryptStr;
}
#pragma mark - 解密内容
...
//    textEncrypContent = [textEncrypContent stringByTrimmingCharactersInSet:[NSCharacterSet controlCharacterSet]];
    ...
    NSString *textContent = [TorquairDecisionful getDecryptStringFromString_MMMethodMMM:textEncrypContent withKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return textContent;
}
...
//    return facebookAppID;
    ...
    return [DrapfoldWife getProjectInfoPlist_MMMethodMMM][@"FacebookAppID"];
}
...
- (NSString *)getSdkBaseEncryptKey_MMMethodMMM{
    ...
    return [DrapfoldWife getBundleIdentifier_MMMethodMMM];
}
