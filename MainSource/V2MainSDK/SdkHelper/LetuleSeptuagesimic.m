...
@interface LetuleSeptuagesimic ()<WKScriptMessageHandler,WKUIDelegate,WKNavigationDelegate>
...
@end
@implementation LetuleSeptuagesimic
...
+(instancetype)webViewControllerPresentingWithURLRequest_MMMethodMMM:(NSURLRequest *)request layoutHandler_MMMethodMMM:(id)handler animation_MMMethodMMM:(BOOL)animation animationStyle_MMMethodMMM:(UIModalTransitionStyle)animationStyle
{
    ...
    LetuleSeptuagesimic *webVC = [[LetuleSeptuagesimic alloc] initWithWebLayoutHandler_MMMethodMMM:handler animation_MMMethodMMM:animation];
