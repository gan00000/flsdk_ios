...
//                                                            AFEventParamCurrency : wwwww_tag_wwwww_USD,
                ...
                gGameUserModel.firstPayTime = [PeopleitionStudentosity getTimeStamp_MMMethodMMM];
                if([[PeopleitionStudentosity getDateStringWithTimeStr_MMMethodMMM:gGameUserModel.firstPayTime dateFormat_MMMethodMMM:@"yyyy-MM-dd"] isEqualToString:[PeopleitionStudentosity getDateStringWithTimeStr_MMMethodMMM:gGameUserModel.regTime dateFormat_MMMethodMMM:@"yyyy-MM-dd"]]){//是否注册首日付费玩家
