...
@interface MCoolFishRameworkTerms : NSObject


@property(nonatomic, copy)NSString *  securityTotalString;
@property(nonatomic, assign)double  arrayMax;
@property(nonatomic, assign)double  ynews_margin;
