...
#import "NoticelikeYourdomView.h"
...
@interface OmniPallicsView()


@end

@implementation OmniPallicsView
{
    HearoonProletView *passwordSDKTextFiledView;
    HearoonProletView *accountSDKTextFiledView;
    ...
    RealwiseDipsoeer *gamaAppleLogin;
    
    BOOL isAgree;
    
    AccountModel *currentAccountModel;
    
    NoticelikeYourdomView *accountListView;
    SophystaylyJejunsiveView *accountMaskView;
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        accountSDKTextFiledView = [[HearoonProletView alloc] initViewWithType_MMMethodMMM:(SDKTextFiledView_Type_Account)];
        ...
        passwordSDKTextFiledView = [[HearoonProletView alloc] initViewWithType_MMMethodMMM:(SDKTextFiledView_Type_Password)];
        ...
        UILabel *rememberTermsLable = [OrbOpen initLabelWithText_MMMethodMMM:xtext fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_C0C0C0]];
        ...
        accountLoginBtn = [OrbOpen initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_login.localx fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kAccountLoginActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        loginGl = [GetMollern createGradientLayerWithRadius_MMMethodMMM:VH(20)];
        ...
        NSMutableArray *loginBtnDatas = [ElsureTraditional getShowBtnDatas_MMMethodMMM:SDK_DATA.mConfigModel appleBtn_MMMethodMMM:YES guestBtn_MMMethodMMM:YES];
        ...
        NSArray<AccountModel *> *mAccountArray = [[DreamerSixry share] getAccountModels_MMMethodMMM];
        if (mAccountArray.count > 0){
            
            currentAccountModel = mAccountArray[0];
            [accountDataList addObjectsFromArray:mAccountArray];
            
            [OmniPallicsView makeAccountFiledViewStatus_MMMethodMMM:currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
        }else{
            if (deleteBtnView) {
            }
        }
        ...
        accountSDKTextFiledView.clickAccountListItem = ^(NSInteger tag) {
            ...
            if (accountMaskView && accountListView) {
                ...
                if (accountMaskView.isHidden) {
                    ...
                    NSArray *mAccountArray = [[DreamerSixry share] getAccountModels_MMMethodMMM];
        ...
        accountSDKTextFiledView.inputTextFieldChange = ^(NSString *msg, NSInteger m, NSDictionary *dic) {
            ...
            if (currentAccountModel && ![currentAccountModel.loginType isEqualToString:LOGIN_TYPE_SELF]) {
                ...
                if (![msg isEqualToString:currentAccountModel.userId]) {
                    ...
                    [OmniPallicsView makeAccountFiledViewStatus_MMMethodMMM:tempAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
...
-(void)addAccountListView_MMMethodMMM{
    ...
    accountMaskView = [[SophystaylyJejunsiveView alloc] init];
    ...
    accountListView = [[NoticelikeYourdomView alloc] init];
    ...
    accountListView.mAccountModelClickHander = ^(BOOL isDelete, AccountModel * _Nullable aModel, NSMutableArray<AccountModel *> *accountDataList) {
        ...
        if (isDelete) {
            ...
            if (accountDataList.count > 0) {
                ...
                [OmniPallicsView makeAccountFiledViewStatus_MMMethodMMM:blockSelf->currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: passwordSDKTextFiledView];
            }else{
...
-(void)requestAccountLogin_MMMethodMMM
{
    ...
    NSString *accountName = [ElsureTraditional triString_MMMethodMMM:accountSDKTextFiledView.inputUITextField.text];
    NSString *pwd = [ElsureTraditional triString_MMMethodMMM:passwordSDKTextFiledView.inputUITextField.text];
    
    
    if (!accountName || [accountName isEqualToString:@""]) {
        [ElsureTraditional toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_py_account_empty)];
        return;
    }
    
    if (![ElsureTraditional validUserName_MMMethodMMM:accountName]) {
        [ElsureTraditional toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_text_account_format)];
        return;
    }
    
    if (!pwd || [pwd isEqualToString:@""]) {
        [ElsureTraditional toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_py_password_empty)];
        return;
    }
    [AudaciitLiquecy selfLoginAndRequest_MMMethodMMM:self.delegate account_MMMethodMMM:accountName pwd_MMMethodMMM:pwd];
}


+(void)makeAccountFiledViewStatus_MMMethodMMM:(AccountModel *)mAccountModel accountView_MMMethodMMM:(HearoonProletView *)accountFiledView pwdView_MMMethodMMM:(HearoonProletView *)pwdFiledView{
...
-(UIView *)addDeleteAccountConfireView_MMMethodMMM
{
    ...
    UIImageView *deleteWarmIV = [OrbOpen initImageViewWithImage_MMMethodMMM:nend_update_account_bg];
    ...
    UILabel *deleteWarmLabel = [OrbOpen initLabelWithText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_delete_account_tips) fontSize_MMMethodMMM:FS(13) textColor_MMMethodMMM:[UIColor whiteColor]];
    ...
    UIButton *cancelBtn = [OrbOpen initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_cancel) fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:UIColor.whiteColor tag_MMMethodMMM:kCancelDeleteAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    UIButton *sureBtn = [OrbOpen initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_confire) fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:UIColor.whiteColor tag_MMMethodMMM:kSureDeleteAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
-(void)addDeleteAccountView_MMMethodMMM
{
    ...
    UIImageView *deleteIV = [OrbOpen initImageViewWithImage_MMMethodMMM:mw_delete_icon];
    ...
    UILabel *delLabel = [OrbOpen initLabelWithText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_delete_account) fontSize_MMMethodMMM:FS(10) textColor_MMMethodMMM:[UIColor blackColor]];
    ...
    [deleteView addTapActionWithBlock_MMMethodMMM:^(UIGestureRecognizer *gestureRecoginzer) {
        ...
        if (!currentAccountModel || [PharmacatoryExperience isEmpty_MMMethodMMM:currentAccountModel.userId]) {
            [ElsureTraditional toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_text_account_not_login)];
            return;
        }
...
- (void)doDeleteAccount_MMMethodMMM {
    ...
    if ([PharmacatoryExperience isEmpty_MMMethodMMM:currentAccountModel.userId]) {
        [ElsureTraditional toastMsg_MMMethodMMM:wwwww_tag_wwwww_text_select_account.localx];
        return;
    }
    [AudaciitLiquecy deleteAccountAndRequest_MMMethodMMM:self.delegate view_MMMethodMMM:self account_MMMethodMMM:currentAccountModel otherParamsDic_MMMethodMMM:nil successBlock_MMMethodMMM:^{
        ...
        if (mAccountArray.count > 0){
            ...
            [OmniPallicsView makeAccountFiledViewStatus_MMMethodMMM:tempA accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: passwordSDKTextFiledView];
