...
@interface OculenEveninglingView ()
@property (copy,nonatomic) void (^completer)(void);
@end

@implementation OculenEveninglingView
{
...
- (void)landspaceView_MMMethodMMM {
    ...
    UILabel *titleLabel = [OrbOpen initLabelWithText_MMMethodMMM:wwwww_tag_wwwww_sdk_terms_title.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_2A2A2A]];
    ...
    UIButton *closeBtn = [OrbOpen initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_close.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:BaseColor] tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    UIButton *okBtn = [OrbOpen initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_agree_read_tips.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kAgreeTermsCheckBoxBtnTag selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    CAGradientLayer *gl = [GetMollern createGradientLayerWithRadius_MMMethodMMM:VH(16)];
...
+ (BOOL)openProvision_MMMethodMMM{
    ...
    return ![OculenEveninglingView isAgreenProvision_MMMethodMMM];
}
