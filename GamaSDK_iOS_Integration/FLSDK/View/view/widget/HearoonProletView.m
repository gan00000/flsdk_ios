...
@implementation HearoonProletView
{
...
- (void) addContentView_MMMethodMMM:(SDKTextFiledView_Type) type
{
    ...
    if (addMoreAccountBtn) {
        ...
        self.moreAccountBtn = [OrbOpen initBtnWithNormalImage_MMMethodMMM:sdk_list_down highlightedImage_MMMethodMMM:sdk_list_down selectedImageName_MMMethodMMM:sdk_list_up tag_MMMethodMMM:kMoreAccountListActTag selector:@selector(clickItemBtn_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    if (showEye) {
        mUITextField.secureTextEntry = NO;
        eyeBtn = [OrbOpen initBtnWithNormalImage_MMMethodMMM:fl_sdk_ky highlightedImage_MMMethodMMM:fl_sdk_ky selectedImageName_MMMethodMMM:fl_sdk_by tag_MMMethodMMM:22 selector:@selector(eyeViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        eyeBtn.selected = YES;
        mUITextField.secureTextEntry = YES;
