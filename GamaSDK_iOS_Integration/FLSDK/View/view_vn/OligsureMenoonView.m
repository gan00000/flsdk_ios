...
@interface OligsureMenoonView()

@end

@implementation OligsureMenoonView
{
...
-(void)addView_MMMethodMMM
{
    ...
    loginTabBtn = [FelothersineEachive initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_login.localx fontSize_MMMethodMMM:FS(24) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:C_TEXT_NORMAL] tag_MMMethodMMM:kLoginTabActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    backBtn = [FelothersineEachive initBtnWithNormalImage_MMMethodMMM:mw_back_icon highlightedImage_MMMethodMMM:mw_back_icon tag_MMMethodMMM:kBackBtnActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    self.mAccountLoginView = [[UponencePrecernView alloc] initView_MMMethodMMM];
    ...
    self.mRegisterAccountView = [[PreventtyManageainView alloc] initView_MMMethodMMM];
