...
@property (nonatomic, strong) BJBaseHTTPEngine *colorC;
...
+ (instancetype)sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        instance.colorC = [[BJBaseHTTPEngine alloc] initWithBasePath_MMMethodMMM:servicePath];
...
+ (void)getRequestWithFunctionPath_MMMethodMMM:(NSString *)path
    ...
    [[HttpServiceEnginePay sharedInstance].colorC getRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
...
+ (void)postRequestWithFunctionPath_MMMethodMMM:(NSString *)path
    ...
    [[HttpServiceEnginePay sharedInstance].colorC postRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
