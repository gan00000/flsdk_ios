...
@implementation SpringSecond

+(void)getAreaInfoWithSuccessBlock_MMMethodMMM:(BJServiceSuccessBlock)successBlock
                                errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    AloneadClin *configHTTPEngine = [[AloneadClin alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/areaCode/areaInfo.json?t=%@", [SchemOnymen getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
        
        NSArray *responseArray = responseData;
        SDK_LOG(@"sdk areaCode info:%@",responseArray);
        if (responseArray) {
            [SemblfactionShootot savePhoneAreaInfo_MMMethodMMM:responseArray];
        }
...
{
    AloneadClin *configHTTPEngine = [[AloneadClin alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/%@/v1/version.json?t=%@", GAME_CODE, [SchemOnymen getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
        ...
        if (mCr) {
            ...
            if (mCr.subVersion){
                ...
                for (ConfigModel *cm in mCr.subVersion) {
                    ...
                    if ([cm.version isEqualToString:[SchemOnymen getBundleVersion_MMMethodMMM]] && [cm.packageName isEqualToString:[SchemOnymen getBundleIdentifier_MMMethodMMM]]) {
            ...
            if (mCr.allVersion){
                ...
                for (ConfigModel *cm in mCr.allVersion) {
                    ...
                    if ([cm.packageName isEqualToString:[SchemOnymen getBundleIdentifier_MMMethodMMM]]) {
                        SDK_DATA.mConfigModel = cm;
                        return;
                    }
                }
                                ...
                                errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    NSString * timeStamp=[SchemOnymen getTimeStamp_MMMethodMMM];
    ...
    AloneadClin *logHTTPEngine = [[AloneadClin alloc] initWithBasePath_MMMethodMMM:[SDKRES getLogUrl_MMMethodMMM]];
             ...
             errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    NSString * md5SignStr=[SchemOnymen getMD5StrFromString_MMMethodMMM:md5str];
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:requestUrlPath params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...

{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_password              :[[SchemOnymen getMD5StrFromString_MMMethodMMM:password] lowercaseString],
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_login_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_get_vfCode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_sendMobileVcode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_bind_phone params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
+ (NSDictionary *)appendCommParamsDic_MMMethodMMM
{
    ...
    @{
        ...
        wwwww_tag_wwwww_packageName      :     [SchemOnymen getBundleIdentifier_MMMethodMMM],
        wwwww_tag_wwwww_adId             :     [[SchemOnymen getIdfa_MMMethodMMM]       lowercaseString]? : @"",
        wwwww_tag_wwwww_idfa             :     [[SchemOnymen getIdfa_MMMethodMMM]       lowercaseString]? : @"",
        wwwww_tag_wwwww_uuid             :     [[SchemOnymen getGamaUUID_MMMethodMMM]     lowercaseString]? : @"",
        wwwww_tag_wwwww_versionName      :     [SchemOnymen getBundleShortVersionString_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_versionCode      :     [SchemOnymen getBundleVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_systemVersion    :     [SchemOnymen getSystemVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_osVersion        :     [SchemOnymen getSystemVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_deviceType       :     [SchemOnymen getDeviceType_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_os               :     wwwww_tag_wwwww_ios, 
        wwwww_tag_wwwww_gameLanguage     :     GAME_LANGUAGE? : @"",
        wwwww_tag_wwwww_osLanguage       :     [SchemOnymen getPreferredLanguage_MMMethodMMM]? : @"",
...
+ (NSMutableDictionary *)appendGameParamsDic_MMMethodMMM
{
    ...
    @try {
        ...
        ClysmizeCephalonatureer *gameUserModel = SDK_DATA.gameUserModel;
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_gameCode         :GAME_CODE,
            wwwww_tag_wwwww_loginId          :userName,
            wwwww_tag_wwwww_password         :[SchemOnymen getMD5StrFromString_MMMethodMMM:password],
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_login_register params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                         ...
                         errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_loginId          :userName,
            wwwww_tag_wwwww_oldPwd           :[[SchemOnymen getMD5StrFromString_MMMethodMMM:oldPassword] lowercaseString],
            wwwww_tag_wwwww_newPwd           :[[SchemOnymen getMD5StrFromString_MMMethodMMM:newPassword] lowercaseString],
            wwwww_tag_wwwww_registPlatform   :LOGIN_TYPE_SELF,
        };
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_change_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                        ...
                        errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_forgot_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_bind_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [EsoSmile postRequestWithFunctionPath_MMMethodMMM:api_delete_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(PayServiceErrorBlock)errorBlock
{
    ...
    [StellIgdoctorry postRequestWithFunctionPath_MMMethodMMM:api_order_create params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(PayServiceErrorBlock)errorBlock
{
    ...
    [StellIgdoctorry postRequestWithFunctionPath_MMMethodMMM:api_payment params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
+ (void)checkPayChannelWithSuccessBlock_MMMethodMMM:(NSString *)productId
    ...
    [StellIgdoctorry postRequestWithFunctionPath_MMMethodMMM:api_check_payment_channel params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
+ (void)checkActSwitchWithSuccessBlock_MMMethodMMM:(NSString *)xxx
    ...
    AloneadClin *configHTTPEngine = [[AloneadClin alloc] initWithBasePath_MMMethodMMM:[SDKRES getPlatUrl_MMMethodMMM]];
