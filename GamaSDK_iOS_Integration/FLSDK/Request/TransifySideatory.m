...
@implementation TransifySideatory

+(void)getAreaInfoWithSuccessBlock_MMMethodMMM:(BJServiceSuccessBlock)successBlock
                                errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    YouiveColdit *configHTTPEngine = [[YouiveColdit alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/areaCode/areaInfo.json?t=%@", [CauseenneSper getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
        
        NSArray *responseArray = responseData;
        SDK_LOG(@"sdk areaCode info:%@",responseArray);
        if (responseArray) {
            [DiseaseitudeGastroaire savePhoneAreaInfo_MMMethodMMM:responseArray];
        }
...
{
    YouiveColdit *configHTTPEngine = [[YouiveColdit alloc] initWithBasePath_MMMethodMMM:[SDKRES getCdnUrl_MMMethodMMM]];
    [configHTTPEngine getRequestWithFunctionPath_MMMethodMMM:[NSString stringWithFormat:@"sdk/config/%@/v1/version.json?t=%@", GAME_CODE, [CauseenneSper getTimeStamp_MMMethodMMM]] params_MMMethodMMM:nil successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
        ...
        if (mCr) {
            ...
            if (mCr.subVersion){
                ...
                for (ConfigModel *cm in mCr.subVersion) {
                    ...
                    if ([cm.version isEqualToString:[CauseenneSper getBundleVersion_MMMethodMMM]] && [cm.packageName isEqualToString:[CauseenneSper getBundleIdentifier_MMMethodMMM]]) {
            ...
            if (mCr.allVersion){
                ...
                for (ConfigModel *cm in mCr.allVersion) {
                    ...
                    if ([cm.packageName isEqualToString:[CauseenneSper getBundleIdentifier_MMMethodMMM]]) {
                        SDK_DATA.mConfigModel = cm;
                        return;
                    }
                }
                                ...
                                errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    NSString * timeStamp=[CauseenneSper getTimeStamp_MMMethodMMM];
    ...
    YouiveColdit *logHTTPEngine = [[YouiveColdit alloc] initWithBasePath_MMMethodMMM:[SDKRES getLogUrl_MMMethodMMM]];
             ...
             errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    NSString * md5SignStr=[CauseenneSper getMD5StrFromString_MMMethodMMM:md5str];
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:requestUrlPath params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
...

{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_password              :[[CauseenneSper getMD5StrFromString_MMMethodMMM:password] lowercaseString],
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_login_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
}
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_get_vfCode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_sendMobileVcode params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                                  ...
                                  errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_bind_phone params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
+ (NSDictionary *)appendCommParamsDic_MMMethodMMM
{
    ...
    @{
        ...
        wwwww_tag_wwwww_packageName      :     [CauseenneSper getBundleIdentifier_MMMethodMMM],
        wwwww_tag_wwwww_adId             :     [[CauseenneSper getIdfa_MMMethodMMM]       lowercaseString]? : @"",
        wwwww_tag_wwwww_idfa             :     [[CauseenneSper getIdfa_MMMethodMMM]       lowercaseString]? : @"",
        wwwww_tag_wwwww_uuid             :     [[CauseenneSper getGamaUUID_MMMethodMMM]     lowercaseString]? : @"",
        wwwww_tag_wwwww_versionName      :     [CauseenneSper getBundleShortVersionString_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_versionCode      :     [CauseenneSper getBundleVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_systemVersion    :     [CauseenneSper getSystemVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_osVersion        :     [CauseenneSper getSystemVersion_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_deviceType       :     [CauseenneSper getDeviceType_MMMethodMMM]? : @"",
        wwwww_tag_wwwww_os               :     wwwww_tag_wwwww_ios, 
        wwwww_tag_wwwww_gameLanguage     :     GAME_LANGUAGE? : @"",
        wwwww_tag_wwwww_osLanguage       :     [CauseenneSper getPreferredLanguage_MMMethodMMM]? : @"",
...
+ (NSMutableDictionary *)appendGameParamsDic_MMMethodMMM
{
    ...
    @try {
        ...
        WhenStrategyably *gameUserModel = SDK_DATA.gameUserModel;
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_gameCode         :GAME_CODE,
            wwwww_tag_wwwww_loginId          :userName,
            wwwww_tag_wwwww_password         :[CauseenneSper getMD5StrFromString_MMMethodMMM:password],
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_login_register params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                         ...
                         errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    @try {
        dic = @{
            ...
            wwwww_tag_wwwww_loginId          :userName,
            wwwww_tag_wwwww_oldPwd           :[[CauseenneSper getMD5StrFromString_MMMethodMMM:oldPassword] lowercaseString],
            wwwww_tag_wwwww_newPwd           :[[CauseenneSper getMD5StrFromString_MMMethodMMM:newPassword] lowercaseString],
            wwwww_tag_wwwww_registPlatform   :LOGIN_TYPE_SELF,
        };
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_change_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                        ...
                        errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_forgot_pwd params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_bind_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(BJServiceErrorBlock)errorBlock
{
    ...
    [OplelSmallite postRequestWithFunctionPath_MMMethodMMM:api_delete_account params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(PayServiceErrorBlock)errorBlock
{
    ...
    [FontneareerCycling postRequestWithFunctionPath_MMMethodMMM:api_order_create params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
                          ...
                          errorBlock_MMMethodMMM:(PayServiceErrorBlock)errorBlock
{
    ...
    [FontneareerCycling postRequestWithFunctionPath_MMMethodMMM:api_payment params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
...
+ (void)checkPayChannelWithSuccessBlock_MMMethodMMM:(NSString *)productId
    ...
    [FontneareerCycling postRequestWithFunctionPath_MMMethodMMM:api_check_payment_channel params_MMMethodMMM:params successBlock_MMMethodMMM:successBlock errorBlock_MMMethodMMM:errorBlock];
