...
@property (nonatomic, strong) BJBaseHTTPEngine *colorw;
...
+ (instancetype)sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        instance.colorw = [[BJBaseHTTPEngine alloc] initWithBasePath_MMMethodMMM:servicePath];
...
+ (void)getRequestWithFunctionPath_MMMethodMMM:(NSString *)path
    ...
    [[HttpServiceEngineLogin sharedInstance].colorw getRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
...
+ (void)postRequestWithFunctionPath_MMMethodMMM:(NSString *)path
    ...
    [SdkUtil showLoadingAtView_MMMethodMMM:nil];
    [[HttpServiceEngineLogin sharedInstance].colorw postRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
...
+ (void)fileUploadWithFunctionPath_MMMethodMMM:(NSString *)functionPath
    ...
    [[HttpServiceEngineLogin sharedInstance].colorw fileUploadWithFunctionPath_MMMethodMMM:functionPath params_MMMethodMMM:params fileData_MMMethodMMM:fileData fileName_MMMethodMMM:fileName mimeType_MMMethodMMM:mimeType progressBlock_MMMethodMMM:^(float progress) {
...
+ (void)imageUploadWithFunctionPath_MMMethodMMM:(NSString *)functionPath
    ...
    [[HttpServiceEngineLogin sharedInstance].colorw imageUploadWithFunctionPath_MMMethodMMM:functionPath params_MMMethodMMM:params imageData_MMMethodMMM:imageData imageName_MMMethodMMM:imageName progressBlock_MMMethodMMM:^(float progress) {
