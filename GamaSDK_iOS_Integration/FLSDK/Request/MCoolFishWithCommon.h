...
@interface MCoolFishWithCommon : NSObject


@property(nonatomic, copy)NSArray *  passwordResponseLabelArray;
@property(nonatomic, assign)NSInteger  create_index;
