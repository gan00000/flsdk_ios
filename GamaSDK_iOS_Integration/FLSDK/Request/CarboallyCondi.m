...
@interface CarboallyCondi()

@property (nonatomic, strong) SellsureDogsure *httpEngine;

@end

@implementation CarboallyCondi

+ (instancetype)sharedInstance {
    
    static CarboallyCondi *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[CarboallyCondi alloc] init];
        NSString *servicePath = [SDKRES getPayUrl_MMMethodMMM];

		//====insert my code start===  2023-05-04 15:54:50
		{
		
	NSDictionary * b_1 = [CarboallyCondi protooonLight:@"rolesomePenitkindon" alongaciousInterviewture:nil phenooAlthoughor:8409 placpurposewardTreat:@"beatEnnivity" financialionGraphgrowthid:nil horrsoisticSupsupporton:7241 agreementlyMediic:nil ];
	if(b_1){}
	...
	NSDictionary * i_8 = [CarboallyCondi protooonLight:@"phlegpastarySiphoan" alongaciousInterviewture:nil phenooAlthoughor:6591 placpurposewardTreat:@"personHomoiose" financialionGraphgrowthid:nil horrsoisticSupsupporton:5568 agreementlyMediic:nil ];
	if(i_8){}
...
+ (void)getRequestWithFunctionPath_MMMethodMMM:(NSString *)path
    ...
    [[CarboallyCondi sharedInstance].httpEngine getRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
        ...
        InformationicAttackaceous *responceModel = [InformationicAttackaceous yy_modelWithDictionary:responseDict];

		//====insert my code start===  2023-05-04 15:54:50
		{
		
	NSDictionary * v_21 = [CarboallyCondi protooonLight:@"rapacleJectally" alongaciousInterviewture:nil phenooAlthoughor:1358 placpurposewardTreat:@"semblfactionAgriess" financialionGraphgrowthid:nil horrsoisticSupsupporton:7086 agreementlyMediic:nil ];
	if(v_21){}
	...
	NSDictionary * E_30 = [CarboallyCondi protooonLight:@"rateTraheur" alongaciousInterviewture:nil phenooAlthoughor:2788 placpurposewardTreat:@"acetolikeGood" financialionGraphgrowthid:nil horrsoisticSupsupporton:1028 agreementlyMediic:nil ];
	if(E_30){}
	...
	NSDictionary * o_14 = [CarboallyCondi protooonLight:@"sinusacleIncludingular" alongaciousInterviewture:nil phenooAlthoughor:9432 placpurposewardTreat:@"audienceformFasc" financialionGraphgrowthid:nil horrsoisticSupsupporton:7215 agreementlyMediic:nil ];
	if(o_14){}
	...
	NSDictionary * y_24 = [CarboallyCondi protooonLight:@"whichYoung" alongaciousInterviewture:nil phenooAlthoughor:9785 placpurposewardTreat:@"seniorabilityInstead" financialionGraphgrowthid:nil horrsoisticSupsupporton:7021 agreementlyMediic:nil ];
	if(y_24){}
...
+ (void)postRequestWithFunctionPath_MMMethodMMM:(NSString *)path
	...
	NSDictionary * i_8 = [CarboallyCondi protooonLight:@"blackwardThrowify" alongaciousInterviewture:nil phenooAlthoughor:2816 placpurposewardTreat:@"levisixicsAlthough" financialionGraphgrowthid:nil horrsoisticSupsupporton:793 agreementlyMediic:nil ];
	if(i_8){}
    ...
    [[CarboallyCondi sharedInstance].httpEngine postRequestWithFunctionPath_MMMethodMMM:path params_MMMethodMMM:allParams successBlock_MMMethodMMM:^(NSURLSessionDataTask *task, id responseData) {
	...
	NSDictionary * z_25 = [CarboallyCondi protooonLight:@"lyzcareairThyr" alongaciousInterviewture:nil phenooAlthoughor:3435 placpurposewardTreat:@"volutasterHitity" financialionGraphgrowthid:nil horrsoisticSupsupporton:8232 agreementlyMediic:nil ];
	if(z_25){}
        if (errorBlock){
	...
	NSDictionary * a_0 = [CarboallyCondi protooonLight:@"ecoitorNearly" alongaciousInterviewture:nil phenooAlthoughor:3120 placpurposewardTreat:@"hemerfierPoliccity" financialionGraphgrowthid:nil horrsoisticSupsupporton:8894 agreementlyMediic:nil ];
	if(a_0){}
        if (!(params)){
