...
@interface CHMXTTChangeTimer : NSObject


@property(nonatomic, assign)Boolean  private_x;
@property(nonatomic, assign)Boolean  enbale_User;
@property(nonatomic, assign)float  create_margin;
