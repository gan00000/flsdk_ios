...
@interface AmicCondfinancialality()
@property (nonatomic,assign) CGFloat viewAdaptRate;
@end

@implementation AmicCondfinancialality

+ (instancetype)share{
    
    static AmicCondfinancialality *_xDimeUtil = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _xDimeUtil = [[AmicCondfinancialality alloc] init];
    });
