...
#define SDK_DEFAULT_BUNDLE_NAME  [[InsteadEnergyo reader_MMMethodMMM] getSdkBundleName_MMMethodMMM]
#define SDK_BUNDLE  [[InsteadEnergyo reader_MMMethodMMM] getMySdkBundle_MMMethodMMM]

#import <Foundation/Foundation.h>

@interface InsteadEnergyo : NSObject
