...
@interface InsteadEnergyo ()
@end

@implementation InsteadEnergyo

static InsteadEnergyo * coreReader;
static dispatch_once_t onceToken;


+ (InsteadEnergyo *)reader_MMMethodMMM
{
    
    dispatch_once(&onceToken,^{
        coreReader = [[InsteadEnergyo alloc] init];
...
-(NSDictionary *)readMainBundleCoreConfInfo_MMMethodMMM
{
    ...
    configDic =[self getJsonContentWithBundle_MMMethodMMM:[NSBundle mainBundle] name_MMMethodMMM:[[SchemOnymen getBundleIdentifier_MMMethodMMM] stringByReplacingOccurrencesOfString:@"." withString:@"_"] ofType_MMMethodMMM:@"json"];
...
- (NSString *)getMd5ResFileName_MMMethodMMM:(NSString *)originalName {
    ...
    NSString *md5EncryptFileName = [SchemOnymen getMD5StrFromString_MMMethodMMM:textEncryptFileName];
...
- (NSString *)encryptContent_MMMethodMMM:(NSString *)textStringContent {
    ...
    NSString *encryptStr = [NotoacleMajorable getEncryptStringFromString_MMMethodMMM:textStringContent WithKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return encryptStr;
}
#pragma mark - 解密内容
- (NSString *)decryptContent_MMMethodMMM:(NSString *)textEncrypContent {
    ...
    NSString *textContent = [NotoacleMajorable getDecryptStringFromString_MMMethodMMM:textEncrypContent withKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return textContent;
}
...
- (NSString *)getServerLanguage_MMMethodMMM{
    ...
    if ([MelanisticSebiition isNotEmpty_MMMethodMMM:languageStr]) {
        return languageStr;
    }
    
    if ([MelanisticSebiition isNotEmpty_MMMethodMMM:[self getStringForKey_MMMethodMMM:@"gameLanguage"]]) {
...
-(NSString *)getFacebookAppId_MMMethodMMM
{
    ...
    return [SchemOnymen getProjectInfoPlist_MMMethodMMM][@"FacebookAppID"];
}
...
- (NSString *)getSdkBaseEncryptKey_MMMethodMMM{
    ...
    return [SchemOnymen getBundleIdentifier_MMMethodMMM];
}
