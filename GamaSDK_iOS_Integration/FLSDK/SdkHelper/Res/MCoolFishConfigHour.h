...
#define SDK_DEFAULT_BUNDLE_NAME  [[MCoolFishConfigHour reader_MMMethodMMM] getSdkBundleName_MMMethodMMM]

#import <Foundation/Foundation.h>

@interface MCoolFishConfigHour : NSObject


@property(nonatomic, assign)NSInteger  foot_count;
@property(nonatomic, copy)NSString *  k_view_str;
