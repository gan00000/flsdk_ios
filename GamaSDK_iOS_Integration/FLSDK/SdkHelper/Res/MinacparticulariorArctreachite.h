...
#define SDK_DEFAULT_BUNDLE_NAME  [[MinacparticulariorArctreachite reader_MMMethodMMM] getSdkBundleName_MMMethodMMM]
#define SDK_BUNDLE  [[MinacparticulariorArctreachite reader_MMMethodMMM] getMySdkBundle_MMMethodMMM]

#import <Foundation/Foundation.h>

@interface MinacparticulariorArctreachite : NSObject
