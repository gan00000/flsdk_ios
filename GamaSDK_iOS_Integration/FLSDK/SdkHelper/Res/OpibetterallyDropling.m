...
#import "OpibetterallyDropling.h"
#import "ResHeader.h"
#import "SdkHeader.h"
#import "PaginkitchenExamplety.h"
#import "CauseenneSper.h"
#import "MWSDK.h"

@interface OpibetterallyDropling ()
@end

@implementation OpibetterallyDropling

static OpibetterallyDropling * coreReader;
static dispatch_once_t onceToken;


+ (OpibetterallyDropling *)reader_MMMethodMMM
{
    
    dispatch_once(&onceToken,^{
        coreReader = [[OpibetterallyDropling alloc] init];
...
-(NSDictionary *)readMainBundleCoreConfInfo_MMMethodMMM
{
    ...
    configDic =[self getJsonContentWithBundle_MMMethodMMM:[NSBundle mainBundle] name_MMMethodMMM:[[CauseenneSper getBundleIdentifier_MMMethodMMM] stringByReplacingOccurrencesOfString:@"." withString:@"_"] ofType_MMMethodMMM:@"json"];
...
- (NSString *)getMd5ResFileName_MMMethodMMM:(NSString *)originalName {
    ...
    NSString *md5EncryptFileName = [CauseenneSper getMD5StrFromString_MMMethodMMM:textEncryptFileName];
...
- (NSString *)encryptContent_MMMethodMMM:(NSString *)textStringContent {
    ...
    NSString *encryptStr = [PaginkitchenExamplety getEncryptStringFromString_MMMethodMMM:textStringContent WithKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return encryptStr;
}
#pragma mark - 解密内容
- (NSString *)decryptContent_MMMethodMMM:(NSString *)textEncrypContent {
    ...
    NSString *textContent = [PaginkitchenExamplety getDecryptStringFromString_MMMethodMMM:textEncrypContent withKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return textContent;
}
...
- (NSString *)getServerLanguage_MMMethodMMM{
    ...
    if ([PietCircumthanklike isNotEmpty_MMMethodMMM:languageStr]) {
        return languageStr;
    }
    
    if ([PietCircumthanklike isNotEmpty_MMMethodMMM:[self getStringForKey_MMMethodMMM:@"gameLanguage"]]) {
...
-(NSString *)getFacebookAppId_MMMethodMMM
{
    ...
    return [CauseenneSper getProjectInfoPlist_MMMethodMMM][@"FacebookAppID"];
}
...
- (NSString *)getSdkBaseEncryptKey_MMMethodMMM{
    ...
    return [CauseenneSper getBundleIdentifier_MMMethodMMM];
}
