...
@interface MinacparticulariorArctreachite ()
@end

@implementation MinacparticulariorArctreachite

static MinacparticulariorArctreachite * coreReader;
static dispatch_once_t onceToken;


+ (MinacparticulariorArctreachite *)reader_MMMethodMMM
{
    
    dispatch_once(&onceToken,^{
        coreReader = [[MinacparticulariorArctreachite alloc] init];
...
-(NSDictionary *)readMainBundleCoreConfInfo_MMMethodMMM
{
    ...
    configDic =[self getJsonContentWithBundle_MMMethodMMM:[NSBundle mainBundle] name_MMMethodMMM:[[PuteeDamnsive getBundleIdentifier_MMMethodMMM] stringByReplacingOccurrencesOfString:@"." withString:@"_"] ofType_MMMethodMMM:@"json"];
...
- (NSString *)getMd5ResFileName_MMMethodMMM:(NSString *)originalName {
    ...
    NSString *md5EncryptFileName = [PuteeDamnsive getMD5StrFromString_MMMethodMMM:textEncryptFileName];
...
- (NSString *)encryptContent_MMMethodMMM:(NSString *)textStringContent {
    ...
    NSString *encryptStr = [LepdomSeniorry getEncryptStringFromString_MMMethodMMM:textStringContent WithKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return encryptStr;
}
#pragma mark - 解密内容
- (NSString *)decryptContent_MMMethodMMM:(NSString *)textEncrypContent {
    ...
    NSString *textContent = [LepdomSeniorry getDecryptStringFromString_MMMethodMMM:textEncrypContent withKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return textContent;
}
...
- (NSString *)getServerLanguage_MMMethodMMM{
    ...
    if ([PharmacatoryExperience isNotEmpty_MMMethodMMM:languageStr]) {
        return languageStr;
    }
    
    if ([PharmacatoryExperience isNotEmpty_MMMethodMMM:[self getStringForKey_MMMethodMMM:@"gameLanguage"]]) {
...
-(NSString *)getFacebookAppId_MMMethodMMM
{
    ...
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"FacebookAppID"];
}
...
- (NSString *)getSdkBaseEncryptKey_MMMethodMMM{
    ...
    return [PuteeDamnsive getBundleIdentifier_MMMethodMMM];
}
