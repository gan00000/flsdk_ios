...
@interface SolidoseArcia ()
@end

@implementation SolidoseArcia

static SolidoseArcia * coreReader;
...
+ (SolidoseArcia *)reader_MMMethodMMM
{
    ...
    dispatch_once(&onceToken,^{
        coreReader = [[SolidoseArcia alloc] init];
...
-(NSDictionary *)readMainBundleCoreConfInfo_MMMethodMMM
{
    ...
    configDic =[self getJsonContentWithBundle_MMMethodMMM:[NSBundle mainBundle] name_MMMethodMMM:[[BreviVincy getBundleIdentifier_MMMethodMMM] stringByReplacingOccurrencesOfString:@"." withString:@"_"] ofType_MMMethodMMM:@"json"];
...
- (NSString *)getMd5ResFileName_MMMethodMMM:(NSString *)originalName {
    ...
    NSString *md5EncryptFileName = [BreviVincy getMD5StrFromString_MMMethodMMM:textEncryptFileName];
...
- (NSString *)encryptContent_MMMethodMMM:(NSString *)textStringContent {
    ...
    NSString *encryptStr = [MenacotStockary getEncryptStringFromString_MMMethodMMM:textStringContent WithKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return encryptStr;
}
#pragma mark - 解密内容
- (NSString *)decryptContent_MMMethodMMM:(NSString *)textEncrypContent {
    ...
    NSString *textContent = [MenacotStockary getDecryptStringFromString_MMMethodMMM:textEncrypContent withKey_MMMethodMMM:eKey iv_MMMethodMMM:eIV];
    return textContent;
}
...
- (NSString *)getServerLanguage_MMMethodMMM{
    ...
    if ([PentadeWhole isNotEmpty_MMMethodMMM:languageStr]) {
        return languageStr;
    }
    
    if ([PentadeWhole isNotEmpty_MMMethodMMM:[self getStringForKey_MMMethodMMM:@"gameLanguage"]]) {
...
-(NSString *)getFacebookAppId_MMMethodMMM
{
    ...
    return [BreviVincy getProjectInfoPlist_MMMethodMMM][@"FacebookAppID"];
}
...
- (NSString *)getSdkBaseEncryptKey_MMMethodMMM{
    ...
    return [BreviVincy getBundleIdentifier_MMMethodMMM];
}
