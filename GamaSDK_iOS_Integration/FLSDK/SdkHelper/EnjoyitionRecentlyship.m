...
@interface EnjoyitionRecentlyship()
@property (nonatomic, strong) NSMutableArray *gamaAreaCodesArray;
@end

@implementation EnjoyitionRecentlyship

- (void)setData {
    
    
    [self resetupAreaCodesAndActionSheetWith_MMMethodMMM:[DiseaseitudeGastroaire getPhoneAreaInfo_MMMethodMMM]];
...
- (void)showAreaCodesActionSheetFromView_MMMethodMMM:(UIButton *)view
{
    ...
    __block EnjoyitionRecentlyship *weakSelf = self;
    
    [DreamismAlthougheous showActionSheetWithTitle_MMMethodMMM:wwwww_tag_wwwww_text_select_phone_area_title.localx
                                    message_MMMethodMMM:@""
