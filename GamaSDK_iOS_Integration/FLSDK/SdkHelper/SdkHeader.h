...
#define SDK_DATA                           [CameraessPlainttrialency sharedSdkData_MMMethodMMM]

#define GetImage(imageName)     [UIImage res_imageNamed_MMMethodMMM:imageName]

#define appTopViewController    [BreviVincy getCurrentViewController_MMMethodMMM]
#define RGB(r,g,b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
#define device_is_iPhoneX   [BreviVincy isIPhoneXSeries_MMMethodMMM]

#pragma mark - 页面字体尺寸适配
#define VH(h)  [[SpecificOnchoy share] getViewHeight_MMMethodMMM:h]
#define VW(w)  [[SpecificOnchoy share] getViewWidth_MMMethodMMM:w]
#define FS(size)  [[SpecificOnchoy share] getFontSize_MMMethodMMM:size]
