...
#import "MinimivityVisithood.h"
#import "UIImage+StegimagineHand.h"
...
#define SDK_DATA                           [PausaciousTrichoice sharedSdkData_MMMethodMMM]

#define GetImage(imageName)     [UIImage res_imageNamed_MMMethodMMM:imageName]

#define appTopViewController    [PeopleitionStudentosity getCurrentViewController_MMMethodMMM]
#define RGB(r,g,b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
#define device_is_iPhoneX   [PeopleitionStudentosity isIPhoneXSeries_MMMethodMMM]

#pragma mark - 页面字体尺寸适配
#define VH(h)  [[MitticalAheadtic share] getViewHeight_MMMethodMMM:h]
#define VW(w)  [[MitticalAheadtic share] getViewWidth_MMMethodMMM:w]
#define FS(size)  [[MitticalAheadtic share] getFontSize_MMMethodMMM:size]
