...
#define SDK_DATA                           [MCoolFishEncodingPhone sharedSdkData_MMMethodMMM]

#define GetImage(imageName)     [UIImage res_imageNamed_MMMethodMMM:imageName]

#define appTopViewController    [MCoolFishResponse getCurrentViewController_MMMethodMMM]
#define RGB(r,g,b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
#define device_is_iPhoneX   [MCoolFishResponse isIPhoneXSeries_MMMethodMMM]

#pragma mark - 页面字体尺寸适配
#define VH(h)  [[MCoolFishTitle share] getViewHeight_MMMethodMMM:h]
#define VW(w)  [[MCoolFishTitle share] getViewWidth_MMMethodMMM:w]
#define FS(size)  [[MCoolFishTitle share] getFontSize_MMMethodMMM:size]
