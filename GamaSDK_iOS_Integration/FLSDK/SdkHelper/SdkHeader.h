...
#import "ReachableRetroable.h"
#import "UIImage+StigmatAroundion.h"
...
#define SDK_DATA                           [AerPlurfaction sharedSdkData_MMMethodMMM]

#define GetImage(imageName)     [UIImage res_imageNamed_MMMethodMMM:imageName]

#define appTopViewController    [ArchaeitiveCivilant getCurrentViewController_MMMethodMMM]
#define RGB(r,g,b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
#define device_is_iPhoneX   [ArchaeitiveCivilant isIPhoneXSeries_MMMethodMMM]

#pragma mark - 页面字体尺寸适配
#define VH(h)  [[AmicCondfinancialality share] getViewHeight_MMMethodMMM:h]
#define VW(w)  [[AmicCondfinancialality share] getViewWidth_MMMethodMMM:w]
#define FS(size)  [[AmicCondfinancialality share] getFontSize_MMMethodMMM:size]
