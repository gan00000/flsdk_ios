...
@interface TenaciPolicedomController ()<WKScriptMessageHandler,WKUIDelegate,WKNavigationDelegate>
...
@implementation TenaciPolicedomController
                                               ...
                                               animation_MMMethodMMM:(BOOL)animation animationStyle_MMMethodMMM:(UIModalTransitionStyle)animationStyle
{
    ...
    TenaciPolicedomController *webVC = [[TenaciPolicedomController alloc] initWithWebLayoutIsShowTitle_MMMethodMMM:isShowTitle animation_MMMethodMMM:animation];
...
- (void)viewDidLoad { 
    ...
    SDK_LOG(@"TenaciPolicedomController viewDidLoad");
    ...
    if(self.isShowTitle){
        ...
        self.backBtn = [OrbOpen initBtnWithNormalImage_MMMethodMMM:icon_back_webview highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_WEB_VIEW_BACK selector:@selector(webGoBack_MMMethodMMM) target_MMMethodMMM:self];
        ...
        self.closeBtn = [OrbOpen initBtnWithNormalImage_MMMethodMMM:icon_close_white highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        self.titleLabel = [OrbOpen initLabelWithText_MMMethodMMM:@"" fontSize_MMMethodMMM:FS(18) textColor_MMMethodMMM:UIColor.whiteColor];
    ...
    if(self.isShowDefulatCloseBtn){
        ...
        self.defalutCloseBtn = [OrbOpen initBtnWithNormalImage_MMMethodMMM:icon_close_3 highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
...
- (void)releaseAll_MMMethodMMM {
    SDK_LOG(@"TenaciPolicedomController releaseAll");
    @try {
...
- (void)dealloc
{
    SDK_LOG(@"TenaciPolicedomController dealloc");
}
