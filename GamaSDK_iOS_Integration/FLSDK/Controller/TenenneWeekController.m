...
@interface TenenneWeekController ()<WKScriptMessageHandler,WKUIDelegate,WKNavigationDelegate>
...
@implementation TenenneWeekController
                                               ...
                                               animation_MMMethodMMM:(BOOL)animation animationStyle_MMMethodMMM:(UIModalTransitionStyle)animationStyle
{
    ...
    TenenneWeekController *webVC = [[TenenneWeekController alloc] initWithWebLayoutIsShowTitle_MMMethodMMM:isShowTitle animation_MMMethodMMM:animation];
...
- (void)viewDidLoad { 
    ...
    SDK_LOG(@"TenenneWeekController viewDidLoad");
    ...
    if(self.isShowTitle){
        ...
        self.backBtn = [AndryColdooret initBtnWithNormalImage_MMMethodMMM:icon_back_webview highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_WEB_VIEW_BACK selector:@selector(webGoBack_MMMethodMMM) target_MMMethodMMM:self];
        ...
        self.closeBtn = [AndryColdooret initBtnWithNormalImage_MMMethodMMM:icon_close_white highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        self.titleLabel = [AndryColdooret initLabelWithText_MMMethodMMM:@"" fontSize_MMMethodMMM:FS(18) textColor_MMMethodMMM:UIColor.whiteColor];
    ...
    if(self.isShowDefulatCloseBtn){
        ...
        self.defalutCloseBtn = [AndryColdooret initBtnWithNormalImage_MMMethodMMM:icon_close_3 highlightedImage_MMMethodMMM:nil tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message   
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if ([message.name isEqualToString:js_close]) {
            ...
            if([DemocratficationNeedern isNotEmpty_MMMethodMMM:eventName]){
...
- (void)releaseAll_MMMethodMMM {
    SDK_LOG(@"TenenneWeekController releaseAll");
    @try {
...
- (void)dealloc
{
    SDK_LOG(@"TenenneWeekController dealloc");
}
