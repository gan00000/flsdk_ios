...
@property(nonatomic, assign)double  event_offset;
@property(nonatomic, assign)float  select_offset;
@property(nonatomic, assign)float  paramMax;
@property(nonatomic, assign)double  orientation_padding;
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        loginGl = [MCoolFishElegateHeader createGradientLayerWithRadius_MMMethodMMM:VH(20)];
...
{
   self.event_offset = 1219.0;

   self.select_offset = 1719.0;

   self.paramMax = 3934.0;

   self.orientation_padding = 3062.0;

   self.interruptCount = 2622;

   self.layoutCount = 7647;
