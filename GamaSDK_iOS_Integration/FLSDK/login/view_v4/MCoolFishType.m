...
@property(nonatomic, assign)long  scriptFlag;
@property(nonatomic, assign)Boolean  enbale_Edit;
@property(nonatomic, assign)long  m_title;
@property(nonatomic, assign)Boolean  has_Popup;
...
{
   self.scriptFlag = 5680;

   self.enbale_Edit = YES;

   self.m_title = 5929;

   self.has_Popup = YES;

   self.hander_padding = 2428.0;

   self.is_Editing = YES;

   self.successNewsFramework_string = @"earplug";
