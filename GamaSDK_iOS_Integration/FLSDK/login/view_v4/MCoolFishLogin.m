...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        [self addDrawRectBolck:^(NSString *msg, NSInteger m, NSDictionary *dic) {
            CAGradientLayer *glLayer = [MCoolFishElegateHeader createGradientLayerWithRadius_MMMethodMMM:VH(25)];
...
- (void)dealloc
{
   self.vipDraw_str = @"strident";

   self.account_size = 1865.0;

   self.fieldDelete_jqModityArr = [NSArray arrayWithObjects:@{@"G":@"N", @"V":@"g"}, nil];
