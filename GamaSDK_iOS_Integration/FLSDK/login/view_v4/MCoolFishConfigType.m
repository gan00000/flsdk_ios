...
@property(nonatomic, assign)NSInteger  genericMark;
@property(nonatomic, copy)NSString *  blockWith_5lAccount_string;
...
- (instancetype)init
{
   self.genericMark = 4099;

   self.blockWith_5lAccount_string = @"instance";

   self.web_index = 5551;

   self.headerMax = 4152.0;

   self.pple_size = 1716.0;
