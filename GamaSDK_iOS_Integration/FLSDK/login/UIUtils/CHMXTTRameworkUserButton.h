...
@interface CHMXTTRameworkUserButton : NSObject


@property(nonatomic, assign)Boolean  enbaleTerm;
@property(nonatomic, assign)float  confMax;
@property(nonatomic, assign)NSInteger  codes_idx;
