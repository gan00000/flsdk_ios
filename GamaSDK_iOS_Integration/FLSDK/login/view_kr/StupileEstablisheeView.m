...
#import "StupileEstablisheeView.h"
#import "SdkHeader.h"
...
- (instancetype)initViewWithBindType_MMMethodMMM:(NSInteger) bindType
{
    ...
    if (self) {
        ...
        regAccountBtn = [LaughelArborthattion initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_confire_reg.localx fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kRegisterAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        CAGradientLayer *gl = [CorticoalityHormship createGradientLayerWithRadius_MMMethodMMM:VH(25)];
...
- (void)registerViewBtnAction_MMMethodMMM:(UIButton *)sender
{
    switch (sender.tag) {
        ...
        case kRegisterAccountActTag:
        {
            ...
            if (![PointsionValueain validPwd_MMMethodMMM:pwd]) {
                return;
            }
          
            [PlaceabilityCribrtic accountRegister_MMMethodMMM:self.delegate view_MMMethodMMM:self areaCode_MMMethodMMM:@"" name:accountName password_MMMethodMMM:pwd phoneNum_MMMethodMMM:@"" vfCode_MMMethodMMM:@""];
