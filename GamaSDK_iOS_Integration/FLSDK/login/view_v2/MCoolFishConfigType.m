...
@property(nonatomic, assign)double  imp_margin;
@property(nonatomic, assign)long  codeTag;
...
- (instancetype)init
{
   self.imp_margin = 3650.0;

   self.codeTag = 9681;

   self.boardIndex = 3153;

   self.helperArray = @[@"subsume"];

   self.bundleIndex = 3312;

   self.enbaleAnimation = NO;
