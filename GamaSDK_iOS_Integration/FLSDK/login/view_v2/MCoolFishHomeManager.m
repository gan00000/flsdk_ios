...
@property(nonatomic, assign)float  failOffset;
@property(nonatomic, copy)NSArray *  http_Array;
...
- (void)finishTimer_MMMethodMMM {
   self.failOffset = 4213.0;

   self.http_Array = @[@(663), @(930), @(434)];

   self.modelOffset = 1724.0;

   self.itemItemSecurityString = @"tomato";

   self.bundleSize = 840.0;

   self.wkwebFrame_gTableList = @[@(155), @(603), @(652)];

   self.readerOffset = 7650.0;
