...
@property(nonatomic, assign)float  rotate_min;
@property(nonatomic, assign)double  window_vv;
@property(nonatomic, copy)NSString *  delegate_4_string;
...
- (void)landspaceView_MMMethodMMM {
   self.rotate_min = 7735.0;

   self.window_vv = 1209.0;

   self.delegate_4_string = @"leadership";

   self.frame_rString = @"barrister";
