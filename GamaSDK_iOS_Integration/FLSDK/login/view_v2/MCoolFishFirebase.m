...
@property(nonatomic, assign)NSInteger  confIndex;
@property(nonatomic, assign)float  phoneSize;
@property(nonatomic, assign)int  p_view;
@property(nonatomic, assign)long  window_28;
...
- (void)showTermsView_MMMethodMMM {
   ...
   self.phoneSize = 7302.0;

   self.p_view = 2895;

   self.window_28 = 8053;

   self.status_arr = @[@(205), @(883)];

   self.dataTag = 676;

   self.serverPadding = 7665.0;
