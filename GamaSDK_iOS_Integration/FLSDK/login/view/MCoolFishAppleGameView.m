...
#import "MCoolFishFrameworkButton.h"

#import <AuthenticationServices/AuthenticationServices.h>

@implementation MCoolFishAppleGameView{
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        mLoginTitleView = [[MCoolFishFiledGestureView alloc] initViewWithTitle_MMMethodMMM:wwwww_tag_wwwww_sureenne_terless hander_MMMethodMMM:^(NSInteger) {
        ...
        UIView *guestBindBtn = [[MCoolFishFrameworkButton alloc] initBtnViewWithType_MMMethodMMM:(SDK_ICON_TITLE_BUTTON_TYPE_BIND_GEUST) tag_MMMethodMMM:kBindGuestActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        [guestBindBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(mLoginTitleView);
              ...
              UIView *fbBindBtn = [[MCoolFishFrameworkButton alloc] initBtnViewWithType_MMMethodMMM:(SDK_ICON_TITLE_BUTTON_TYPE_BIND_FB) tag_MMMethodMMM:kBindFBActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        switch (sender.tag) {
            case kBindAppleActTag:
            {
                ...
                if (@available(iOS 13, *)) {
                     ...
                     [MCoolFishUserEdit showAlertWithMessage_MMMethodMMM:GetString(wwwww_tag_wwwww_GAMA_APPLE_SYSTEM_OLD_WARNING)];
                      return;
                  }
            }
