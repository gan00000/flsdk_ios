...
@interface MCoolFishUtilView()


@property(nonatomic, copy)NSArray *  message_list;
@property(nonatomic, copy)NSString *  levelImpCurrent_string;
@property(nonatomic, assign)Boolean  is_Handler;
@property(nonatomic, assign)int  labelCount;


@end

@implementation MCoolFishUtilView
{
...
- (void)dealloc{
   self.message_list = @[@(3), @(258)];

   self.levelImpCurrent_string = @"ad";

   self.is_Handler = NO;

   self.labelCount = 2483;

   self.hasBackground = YES;

   self.user_Array = [NSArray arrayWithObjects:@(793), @(930), nil];

   self.currentCount = 304;

   self.maskCodesCallList = [NSArray arrayWithObjects:@(243), @(804), @(615), nil];
    ...
    accountListView.mAccountModelClickHander = ^(BOOL isDelete, AccountModel * _Nullable aModel, NSMutableArray<AccountModel *> *list) {
        ...
        if (isDelete) {
            ...
            if (accountDataList.count > 0) {
                ...
                [MCoolFishInterruptView makeAccountFiledViewStatus_MMMethodMMM:blockSelf->currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: nil];
            }else{
            ...
            accountMaskView.hidden = YES;
            [MCoolFishInterruptView makeAccountFiledViewStatus_MMMethodMMM:blockSelf->currentAccountModel accountView_MMMethodMMM:blockSelf->accountSDKTextFiledView pwdView_MMMethodMMM:nil];
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        mLoginTitleView = [[MCoolFishFiledGestureView alloc] initViewWithTitle_MMMethodMMM:GetString(wwwww_tag_wwwww_text_welcome_back) hander_MMMethodMMM:^(NSInteger) {
        ...
        accountLoginBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_go_game) fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kGoGameActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        swithAccountBtn_2 = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_switch_account) fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kSwitchAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        update_change_btn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_update_account_bind) fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kBindAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        swithAccountBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_switch_account) fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kSwitchAccountActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        if (mAccountArray.count > 0){
            ...
            [MCoolFishInterruptView makeAccountFiledViewStatus_MMMethodMMM:currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: nil];
...
-(void)addDeleteAccountView_MMMethodMMM
{
    ...
    UILabel *delLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_delete_account) fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor blackColor]];
...
-(void)goGame_MMMethodMMM
{
    ...
    if ([currentAccountModel.loginType isEqualToString:LOGIN_TYPE_SELF]) {
        ...
        [MCoolFishBlock selfLoginAndRequest_MMMethodMMM:self.delegate account_MMMethodMMM:currentAccountModel.account pwd_MMMethodMMM:currentAccountModel.password];
