...
@interface MCoolFishWelcomeTouchView()


@property(nonatomic, copy)NSString *  indicatorUtil_str;
@property(nonatomic, assign)float  passwordMax;


@end

@implementation MCoolFishWelcomeTouchView
{
...
{
   self.indicatorUtil_str = @"gettogether";

   self.passwordMax = 1252.0;

   self.handerSum = 2578;

   self.efaultAdapt_string = @"perpendicular";

   self.configuratorFailNews_str = @"theocracy";
...
-(void)addView_MMMethodMMM
{
    ...
    UIButton *guestTextBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_archae_effortfold fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:guestLoginActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    UILabel *hasAccountLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:@"已有帳號？ " fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor whiteColor]];
    ...
    UILabel *loginLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:wwwww_tag_wwwww_vigenast_claimistic fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_EB2E2B]];
    ...
    UILabel *otherLoginLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:wwwww_tag_wwwww_mostery_tricesimreachory fontSize_MMMethodMMM:FS(11) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_C0C0C0]];
