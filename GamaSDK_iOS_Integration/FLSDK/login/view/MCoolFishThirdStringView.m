...
@interface MCoolFishThirdStringView()


@property(nonatomic, assign)float  query_offset;
@property(nonatomic, assign)double  changeSize;
@property(nonatomic, assign)double  color_offset;


@end

@implementation MCoolFishThirdStringView
{
...
-(void)addView_MMMethodMMM
{
    ...
    loginTabBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_vigenast_claimistic fontSize_MMMethodMMM:FS(24) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_848484] tag_MMMethodMMM:kLoginTabActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    UIButton *backBtn = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:mw_back_icon highlightedImage_MMMethodMMM:mw_back_icon tag_MMMethodMMM:kBackBtnActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    self.mAccountLoginView = [[MCoolFishInterruptView alloc] initView_MMMethodMMM];
    ...
    self.mRegisterAccountView = [[MCoolFishModityOrderView alloc] initView_MMMethodMMM];
    ...
    switch (sender.tag) {
        ...
        case kBackBtnActTag:
            ...
            if (self.delegate) {
                ...
                NSArray<AccountModel *> *ams = [[MCoolFishPple share] getAccountModels_MMMethodMMM];
...
{
   self.query_offset = 2740.0;

   self.changeSize = 3951.0;

   self.color_offset = 6622.0;

   self.enbale_Fail = YES;

   self.function_count = 9166;

   self.delegate_8List = [NSArray arrayWithObjects:@(674), @(347), @(492), nil];

   self.generic_tag = 6878;
