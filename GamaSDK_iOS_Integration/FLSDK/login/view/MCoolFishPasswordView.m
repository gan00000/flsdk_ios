...
@implementation MCoolFishPasswordView
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        mLoginTitleView = [[MCoolFishFiledGestureView alloc] initViewWithTitle_MMMethodMMM:GetString(wwwww_tag_wwwww_text_update_account) hander_MMMethodMMM:^(NSInteger) {
        ...
        UIButton *okBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_confire_update) fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kOkActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
- (void)registerViewBtnAction_MMMethodMMM:(UIButton *)sender
{
   ...
   self.editingPadding = 9647.0;

   self.messageTag = 9872;
...
-(void)bindAccount_MMMethodMMM
{
    ...
    if (![MCoolFishEventFile validPwd_MMMethodMMM:pasword]) {
        return;
    }
    ...
    [MCoolFishBlock bindAccountAndRequest_MMMethodMMM:self.delegate view_MMMethodMMM:self account_MMMethodMMM:currentAccountModel account_MMMethodMMM:account pwd_MMMethodMMM:pasword];
}
