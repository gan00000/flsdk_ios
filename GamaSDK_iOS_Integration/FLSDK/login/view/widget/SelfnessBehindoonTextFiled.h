...
@interface SelfnessBehindoonTextFiled : MightfyCrutfulView


@property(nonatomic, copy)NSArray *  transactionsArray;
@property(nonatomic, copy)NSString *  projectBackgroundCommon_str;
