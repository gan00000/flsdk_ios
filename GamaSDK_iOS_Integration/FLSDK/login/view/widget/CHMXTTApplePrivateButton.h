...
@interface CHMXTTApplePrivateButton : UIView


@property(nonatomic, copy)NSArray *  item_Array;
@property(nonatomic, assign)NSInteger  handerCount;
@property(nonatomic, copy)NSString *  erviceAccessSecurityStr;
@property(nonatomic, copy)NSArray *  findLableMainArr;
