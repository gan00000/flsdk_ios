...
@implementation MCoolFishPrivateCell
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
   self.adapt_padding = 2531.0;

   self.password_count = 1079;

   self.configurator_arr = [NSArray arrayWithObjects:@[@(3215)], nil];
...
- (void)addCellView_MMMethodMMM{
    ...
    self.deleteAccountBtn = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:delete_icon highlightedImage_MMMethodMMM:delete_icon tag_MMMethodMMM:kMoreAccountDeleteActTag selector:@selector(deleteAccontClick_MMMethodMMM:) target_MMMethodMMM:self];
