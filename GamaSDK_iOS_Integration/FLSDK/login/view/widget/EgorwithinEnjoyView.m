...
@interface EgorwithinEnjoyView()<UITableViewDelegate, UITableViewDataSource>

    
@end

@implementation EgorwithinEnjoyView{
...
- (void)addAccountListTableView_MMMethodMMM
{
    ...
    [_accountListTableView registerClass:[PhanformCaloriorCell class] forCellReuseIdentifier:AccountListViewCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath { 
    ...
    PhanformCaloriorCell *cell = [tableView dequeueReusableCellWithIdentifier:AccountListViewCellID forIndexPath:indexPath];
	...
	if(k_10){}
        ...
        if (tag == kMoreAccountDeleteActTag) {
            ...
            [[SimplyaticCar share] removeAccountByUserId_MMMethodMMM:mAccountModel.userId];
	...
	if(h_7){}
		...
		//====insert my code end===  2023-05-04 15:54:51
            ...
            [self.accountDataList addObjectsFromArray:[[SimplyaticCar share] getAccountModels_MMMethodMMM]];
