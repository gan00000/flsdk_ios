...
@implementation MCoolFishGamaCommonView
...
- (void)addPhoneViewContentView_MMMethodMMM
{
    ...
    UIButton *dropButton = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:sdk_list_down highlightedImage_MMMethodMMM:sdk_list_down tag_MMMethodMMM:222 selector:@selector(itemBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        self.phoneModel = [[MCoolFishRequestEdit alloc] init];
...
{
   self.rameworkArr = @[@(1000), @(85)];

   self.editingItem_Array = [NSArray arrayWithObjects:@(497), @(185), nil];
