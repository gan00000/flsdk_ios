...
@implementation MCoolFishFrameworkButton
...
{
   self.centerImpl_str = @"specialized";

   self.arac_size = 5462.0;
    ...
    if (self) {
        ...
        UIButton *mButton = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:nil fontSize_MMMethodMMM:14 textColor_MMMethodMMM:nil tag_MMMethodMMM:tag selector:selector target_MMMethodMMM:target];
