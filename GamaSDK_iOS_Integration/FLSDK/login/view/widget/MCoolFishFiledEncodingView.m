...
@implementation MCoolFishFiledEncodingView
{
...
-(void)setPwdFiledView_MMMethodMMM:(BOOL)enable{
   self.backgroundIndex = 7228;

   self.erviceFirebaseWeb_str = @"reminiscence";

   self.line_margin = 289.0;

   self.request_offset = 6820.0;
...
- (void) addContentView_MMMethodMMM:(SDKTextFiledView_Type) type
{
    ...
    if (addMoreAccountBtn) {
        ...
        self.moreAccountBtn = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:sdk_list_down highlightedImage_MMMethodMMM:sdk_list_down selectedImageName_MMMethodMMM:sdk_list_up tag_MMMethodMMM:kMoreAccountListActTag selector:@selector(clickItemBtn_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    if (showEye) {
        mUITextField.secureTextEntry = NO;
        eyeBtn = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:fl_sdk_ky highlightedImage_MMMethodMMM:fl_sdk_ky selectedImageName_MMMethodMMM:fl_sdk_by tag_MMMethodMMM:22 selector:@selector(eyeViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        eyeBtn.selected = YES;
        mUITextField.secureTextEntry = YES;
