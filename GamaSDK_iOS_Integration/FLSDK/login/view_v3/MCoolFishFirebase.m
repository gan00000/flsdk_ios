...
@property(nonatomic, assign)double  bundleSpace;
@property(nonatomic, assign)int  home_index;
@property(nonatomic, copy)NSArray *  button_list;
...
{
   self.bundleSpace = 1085.0;

   self.home_index = 4578;

   self.button_list = [NSArray arrayWithObjects:@(YES), nil];

   self.arrayExpression_Array = @[@(550), @(37)];

   self.close_sum = 1860;

   self.editing_space = 9755.0;
