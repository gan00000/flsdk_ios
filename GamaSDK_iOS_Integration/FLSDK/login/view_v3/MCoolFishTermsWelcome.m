...
@implementation MCoolFishTermsWelcome

{
    MCoolFishFiledEncodingView *thirdAccountSDKTextFiledView;
    MCoolFishFiledEncodingView *accountSDKTextFiledView;
    MCoolFishFiledEncodingView *pwdSDKTextFiledView;
    
    MCoolFishFiledEncodingView *hasBind_accountSDKTextFiledView;
...
- (void)initData_MMMethodMMM
{
    ...
    [MCoolFishInterruptView makeAccountFiledViewStatus_MMMethodMMM:tempAccountModel accountView_MMMethodMMM:thirdAccountSDKTextFiledView pwdView_MMMethodMMM:nil];
...
{
   self.bindRrorConfiguratorStr = @"pyre";

   self.rotate_mark = 2899;

   self.termsGameConfigList = [NSArray arrayWithObjects:@(978), @(414), nil];
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        UILabel *titleLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:wwwww_tag_wwwww_text_update_account.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_2A2A2A]];
        ...
        UIButton *closeBtn = [MCoolFishConfig initBtnWithNormalImage_MMMethodMMM:icon_close_3 highlightedImage_MMMethodMMM:icon_close_3 tag_MMMethodMMM:TAG_CLOSE selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        if (currentAccount.isBind) {
            ...
            thirdAccountSDKTextFiledView = [[MCoolFishFiledEncodingView alloc] initViewWithType_MMMethodMMM:(SDKTextFiledView_Type_Account)];
            ...
            hasBind_accountSDKTextFiledView = [[MCoolFishFiledEncodingView alloc] initViewWithType_MMMethodMMM:(SDKTextFiledView_Type_Account)];
            ...
            pwdSDKTextFiledView = [[MCoolFishFiledEncodingView alloc] initViewWithType_MMMethodMMM:(SDKTextFiledView_Type_Password)];
            ...
            UILabel *bindTipLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_bind_account_tips) fontSize_MMMethodMMM:FS(10) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_C0C0C0]];
        ...
        UIButton *okBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_text_confire) fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kOkActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
