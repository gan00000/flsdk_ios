...
@property(nonatomic, copy)NSArray *  timerResponseArr;
@property(nonatomic, copy)NSArray *  boardHelperStrings_list;
@property(nonatomic, assign)float  modeSpace;
@property(nonatomic, assign)long  orderIdx;
...
- (void)finishTimer_MMMethodMMM {
   self.timerResponseArr = [NSArray arrayWithObjects:@(120), @(765), nil];

   self.boardHelperStrings_list = @[@(875), @(376)];

   self.modeSpace = 8167.0;

   self.orderIdx = 8292;

   self.lnewsList = @[@(8565)];

   self.string_count = 5370;
