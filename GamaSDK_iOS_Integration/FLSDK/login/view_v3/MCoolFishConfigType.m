...
@interface MCoolFishConfigType ()

@property(nonatomic, copy)NSArray *  stringsWindow_yy_Array;
@property(nonatomic, copy)NSArray *  mainImageCoreArray;


@property (copy,nonatomic) void (^completer)(void);
@end

@implementation MCoolFishConfigType
{
...
{
   self.stringsWindow_yy_Array = [NSArray arrayWithObjects:@(199), @(247), @(198), nil];

   self.mainImageCoreArray = @[@(2), @(736), @(499)];

   self.colorList = [NSArray arrayWithObjects:@(463), @(267), @(668), nil];

   self.bindSize = 2439.0;
...
- (void)landspaceView_MMMethodMMM {
    ...
    UILabel *titleLabel = [MCoolFishConfig initLabelWithText_MMMethodMMM:wwwww_tag_wwwww_sdk_terms_title.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:wwwww_tag_wwwww__CC_2A2A2A]];
    ...
    UIButton *closeBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_close.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:BaseColor] tag_MMMethodMMM:TAG_CLOSE selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    UIButton *okBtn = [MCoolFishConfig initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_agree_read_tips.localx fontSize_MMMethodMMM:FS(15) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kAgreeTermsCheckBoxBtnTag selector:@selector(btnClickAction_MMMethodMMM:) target_MMMethodMMM:self];
    ...
    CAGradientLayer *gl = [MCoolFishElegateHeader createGradientLayerWithRadius_MMMethodMMM:VH(16)];
...
+ (BOOL)openProvision_MMMethodMMM{
    ...
    return ![MCoolFishConfigType isAgreenProvision_MMMethodMMM];
}
