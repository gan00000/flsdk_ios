...
@interface MCoolFishButtonConfigurator : MCoolFishRegisterView 


@property(nonatomic, copy)NSArray *  engineFirebaseFieldArray;
@property(nonatomic, assign)float  roleOffset;
@property(nonatomic, assign)double  alertSize;
