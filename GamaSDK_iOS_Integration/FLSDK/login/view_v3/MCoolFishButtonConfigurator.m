...
@property(nonatomic, assign)double  alertMax;
@property(nonatomic, assign)NSInteger  roleFlag;
@property(nonatomic, assign)double  param_size;
@property(nonatomic, assign)Boolean  enbaleTable;
...
{
   self.alertMax = 9291.0;

   self.roleFlag = 8503;

   self.param_size = 600.0;

   self.enbaleTable = NO;

   self.engineFirebaseFieldArray = @[@(760), @(258)];

   self.roleOffset = 7394.0;

   self.alertSize = 903.0;
