...
@property(nonatomic, assign)NSInteger  array_tag;
@property(nonatomic, assign)NSInteger  coreMark;
@property(nonatomic, assign)double  message_offset;
...
- (void)landspaceView_MMMethodMMM {
   ...
   self.message_offset = 1824.0;

   self.utilList = @[@(61), @(842), @(9)];

   self.adapt_index = 926;
