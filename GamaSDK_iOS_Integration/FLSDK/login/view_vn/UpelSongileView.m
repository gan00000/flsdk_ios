...
@interface UpelSongileView()


@end

@implementation UpelSongileView
{
...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        UIButton *findPasswordBtn = [SmilePitate initBtnWithTitleText_MMMethodMMM:GetString(wwwww_tag_wwwww_py_findpwd) fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:C_TEXT_NORMAL] tag_MMMethodMMM:kFindPwdActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        checkBoxTermsBtn = [SmilePitate initBtnWithNormalImage_MMMethodMMM:mw_cb_uncheck highlightedImage_MMMethodMMM:nil selectedImageName_MMMethodMMM:mw_cb_check tag_MMMethodMMM:kAgreeTermsCheckBoxBtnTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        checkBoxTermsBtn.selected = YES;
        ...
        UILabel *rememberTermsLable = [SmilePitate initLabelWithText_MMMethodMMM:xtext fontSize_MMMethodMMM:FS(12) textColor_MMMethodMMM:[UIColor colorWithHexString_MMMethodMMM:C_TEXT_NORMAL]];
        ...
        accountLoginBtn = [SmilePitate initBtnWithTitleText_MMMethodMMM:wwwww_tag_wwwww_text_login.localx fontSize_MMMethodMMM:FS(17) textColor_MMMethodMMM:[UIColor whiteColor] tag_MMMethodMMM:kAccountLoginActTag selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        loginGl = [LuminseaicalPresentth createGradientLayerWithRadius_MMMethodMMM:VH(5)];
        ...
        NSMutableArray *loginBtnDatas = [DiseaseitudeGastroaire getShowBtnDatas_MMMethodMMM:SDK_DATA.mConfigModel appleBtn_MMMethodMMM:YES guestBtn_MMMethodMMM:YES];
        ...
        for (int i = 0; i < loginBtnDatas.count; i++) {
            ...
            if ([lbd.btnType isEqualToString:LOGIN_TYPE_APPLE]) {
                ...
                PylletUdintudeeousButton *mBtn = [[PylletUdintudeeousButton alloc] initWithType_MMMethodMMM:lbd.tag title_MMMethodMMM:@"" image_MMMethodMMM:lbd.image selector:@selector(registerViewBtnAction_MMMethodMMM:) target_MMMethodMMM:self];
        ...
        if (mAccountArray.count > 0){
            ...
            [UpelSongileView makeAccountFiledViewStatus_MMMethodMMM:currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
        }else{
            if (deleteBtnView) {
            }
        }
        ...
        accountSDKTextFiledView.inputTextFieldChange = ^(NSString *msg, NSInteger m, NSDictionary *dic) {
            ...
            if (currentAccountModel && ![currentAccountModel.loginType isEqualToString:LOGIN_TYPE_SELF]) {
                ...
                if (![msg isEqualToString:currentAccountModel.userId]) {
                    ...
                    [UpelSongileView makeAccountFiledViewStatus_MMMethodMMM:tempAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM:passwordSDKTextFiledView];
    ...
    accountListView.mAccountModelClickHander = ^(BOOL isDelete, AccountModel * _Nullable aModel, NSMutableArray<AccountModel *> *accountDataList) {
        ...
        if (isDelete) {
            ...
            if (accountDataList.count > 0) {
                ...
                [UpelSongileView makeAccountFiledViewStatus_MMMethodMMM:blockSelf->currentAccountModel accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: passwordSDKTextFiledView];
            }else{
...
-(BOOL)checkAgreeTerm_MMMethodMMM
{
    ...
    [DiseaseitudeGastroaire toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_text_term_not_read)];
...
-(void)requestAccountLogin_MMMethodMMM
{
    ...
    NSString *accountName = [DiseaseitudeGastroaire triString_MMMethodMMM:accountSDKTextFiledView.inputUITextField.text];
    NSString *pwd = [DiseaseitudeGastroaire triString_MMMethodMMM:passwordSDKTextFiledView.inputUITextField.text];
    
    
    if (!accountName || [accountName isEqualToString:@""]) {
        [DiseaseitudeGastroaire toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_py_account_empty)];
        return;
    }
    
    if (![DiseaseitudeGastroaire validUserName_MMMethodMMM:accountName]) {
        [DiseaseitudeGastroaire toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_text_account_format)];
        return;
    }
    ...
    [AloneuleCipitdifferenting selfLoginAndRequest_MMMethodMMM:self.delegate account_MMMethodMMM:accountName pwd_MMMethodMMM:pwd];
}


+(void)makeAccountFiledViewStatus_MMMethodMMM:(AccountModel *)mAccountModel accountView_MMMethodMMM:(RhombtyWesternentView *)accountFiledView pwdView_MMMethodMMM:(RhombtyWesternentView *)pwdFiledView{
...
{
    if (!currentAccountModel || [PietCircumthanklike isEmpty_MMMethodMMM:currentAccountModel.userId]) {
        [DiseaseitudeGastroaire toastMsg_MMMethodMMM:GetString(wwwww_tag_wwwww_text_account_not_login)];
        return nil;
    }
...
- (void)doDeleteAccount_MMMethodMMM {
    ...
    if ([PietCircumthanklike isEmpty_MMMethodMMM:currentAccountModel.userId]) {
        [DiseaseitudeGastroaire toastMsg_MMMethodMMM:wwwww_tag_wwwww_text_select_account.localx];
        return;
    }
    [AloneuleCipitdifferenting deleteAccountAndRequest_MMMethodMMM:self.delegate view_MMMethodMMM:self account_MMMethodMMM:currentAccountModel otherParamsDic_MMMethodMMM:nil successBlock_MMMethodMMM:^{
        ...
        if (mAccountArray.count > 0){
            ...
            [UpelSongileView makeAccountFiledViewStatus_MMMethodMMM:tempA accountView_MMMethodMMM:accountSDKTextFiledView pwdView_MMMethodMMM: passwordSDKTextFiledView];
