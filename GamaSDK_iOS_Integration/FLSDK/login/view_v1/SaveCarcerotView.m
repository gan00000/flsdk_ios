...
@interface SaveCarcerotView ()
@property (copy,nonatomic) void (^completer)(void);
@end

@implementation SaveCarcerotView
{
...
- (void)landspaceView_MMMethodMMM {
    ...
    mLoginTitleView = [[MulctfulHemeresqueView alloc] initViewWithTitle_MMMethodMMM:GetString(wwwww_tag_wwwww_sdk_terms_title) hander_MMMethodMMM:^(NSInteger param) {
...
+ (BOOL)openProvision_MMMethodMMM{
    ...
    return ![SaveCarcerotView isAgreenProvision_MMMethodMMM];
}
