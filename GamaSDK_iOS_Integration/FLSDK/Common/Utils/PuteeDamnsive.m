...
@implementation PuteeDamnsive

#pragma mark - 获取GamaCfUUID
+ (NSString *)getGamaUUID_MMMethodMMM
{
    NSString * gamaUUid = [[CallionGonyion getCustomCfUUID_MMMethodMMM] lowercaseString];
    return gamaUUid;
}

+ (NSString *)bundleSeedID_MMMethodMMM
{
    NSString * gamaBundleSeedId=[CallionGonyion bundleSeedID_MMMethodMMM];
    return gamaBundleSeedId;
}

+ (NSString *)getBundleName_MMMethodMMM
{
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"CFBundleName"];
}

+ (NSString *)getBundleIdentifier_MMMethodMMM
{
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"CFBundleIdentifier"];
}

+ (NSString *)getBundleShortVersionString_MMMethodMMM
{
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"CFBundleShortVersionString"];
}

+ (NSString *)getBundleVersion_MMMethodMMM
{
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"CFBundleVersion"];
}

+ (NSString *)getDisplayName_MMMethodMMM
{
    return [PuteeDamnsive getProjectInfoPlist_MMMethodMMM][@"CFBundleDisplayName"];
}
...
+(NSString *)getDateStringWithTimeStr_MMMethodMMM:(NSString *)str dateFormat_MMMethodMMM:(NSString *)dateFormat{
    ...
    if([PharmacatoryExperience isEmpty_MMMethodMMM:dateFormat]){
...
+ (NSString*)getPreferredLanguage_MMMethodMMM
{
    ...
    if ([PuteeDamnsive getSystemVersion_MMMethodMMM].intValue >= 9.0) {
...
+ (BOOL)checkValue_MMMethodMMM:(id)value key_MMMethodMMM:(NSString *)key andURLScheme_MMMethodMMM:(NSString *)urlScheme andURLIdentifier_MMMethodMMM:(NSString *)identifier
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [AsacleChronible showAlertWithMessage_MMMethodMMM:showTips];
    });
    return NO;
}
