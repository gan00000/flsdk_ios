...
@implementation MCoolFishRespCore
...
{
    return [MCoolFishRespCore getProjectInfoPlist_MMMethodMMM][@"CFBundleName"];
}


+ (NSString *)getBundleIdentifier_MMMethodMMM
{
    return [MCoolFishRespCore getProjectInfoPlist_MMMethodMMM][@"CFBundleIdentifier"];
}
...
{
    return [MCoolFishRespCore getProjectInfoPlist_MMMethodMMM][@"CFBundleVersion"];
}
...
{
    return [MCoolFishRespCore getProjectInfoPlist_MMMethodMMM][@"CFBundleShortVersionString"];
}
...
+ (NSString*)getPreferredLanguage_MMMethodMMM
{
    ...
    if ([MCoolFishRespCore getSystemVersion_MMMethodMMM].intValue >= 9.0) {
