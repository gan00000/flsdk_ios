...
@implementation MCoolFishResponse
...
+ (BOOL)checkValue_MMMethodMMM:(id)value key_MMMethodMMM:(NSString *)key andURLScheme_MMMethodMMM:(NSString *)urlScheme andURLIdentifier_MMMethodMMM:(NSString *)identifier
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [MCoolFishUserEdit showAlertWithMessage_MMMethodMMM:showTips];
    });
    return NO;
}
...
+ (NSString*)getPreferredLanguage_MMMethodMMM
{
    ...
    if ([MCoolFishResponse getSystemVersion_MMMethodMMM].intValue >= 9.0) {
...
{
    NSString * gamaBundleSeedId=[MCoolFishNews bundleSeedID_MMMethodMMM];
...
{
    return [MCoolFishResponse getProjectInfoPlist_MMMethodMMM][@"CFBundleVersion"];
}
...
{
    return [MCoolFishResponse getProjectInfoPlist_MMMethodMMM][@"CFBundleName"];
}
...
{
    return [MCoolFishResponse getProjectInfoPlist_MMMethodMMM][@"CFBundleShortVersionString"];
}
...
{
    return [MCoolFishResponse getProjectInfoPlist_MMMethodMMM][@"CFBundleIdentifier"];
}
...
{
    NSString * gamaUUid = [[MCoolFishNews getCustomCfUUID_MMMethodMMM] lowercaseString];
    return gamaUUid;
}
