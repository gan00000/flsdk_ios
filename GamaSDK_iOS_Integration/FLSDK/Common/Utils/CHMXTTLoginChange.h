...
@interface CHMXTTLoginChange : NSObject



@property(nonatomic, assign)int  http_count;
@property(nonatomic, assign)double  fetchOffset;
@property(nonatomic, assign)int  textIdx;




+(NSDictionary *)tempNetdbGameRegistrationSysctlMain;

+(NSDictionary *)observePlainSourcePathSingleAdvertising:(NSArray *)wedthWedth;
