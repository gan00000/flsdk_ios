...
@interface PeopleitionStudentosity : NSObject


@property(nonatomic, assign)double  y_view;
@property(nonatomic, assign)float  gameSpace;
@property(nonatomic, copy)NSArray *  formatInformationArr;
@property(nonatomic, assign)double  terminate_margin;
