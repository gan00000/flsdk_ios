...
@interface MCoolFishThird (PrivateMethods)
...
{
   self.callbackSum = 9079;

   self.progress_min = 5951.0;

   self.impCallStr = @"fifth";

   self.enbale_Model = NO;
