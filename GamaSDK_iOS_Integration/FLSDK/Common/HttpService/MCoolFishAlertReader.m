...
@interface MCoolFishAlertReader ()


@property(nonatomic, copy)NSString *  codes_string;
@property(nonatomic, copy)NSArray *  loggerArray;
@property(nonatomic, assign)Boolean  has_Strings;
...
@implementation MCoolFishAlertReader
...
- (void)fileUploadWithFunctionPath_MMMethodMMM:(NSString *)functionPath
   ...
   self.codes_string = @"pending";

   self.loggerArray = @[@(105), @(273)];

   self.has_Strings = YES;

   self.enbale_Error = NO;
