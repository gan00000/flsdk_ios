...
+ (UIAlertView *)_showAlertViewWithTitle_MMMethodMMM:(NSString *)title
                            ...
                            buttonTitles_MMMethodMMM:(NSArray *)buttonTitles
                              completion:(SAlertViewHandler)handler
{
    if ([MCoolFishResponse getSystemVersion_MMMethodMMM].intValue >= 8)
    {
    ...
    else
    {
        UIAlertView * alert=[[UIAlertView alloc]initWithTitle:title
                                                      message:message
                                                     delegate:
                             [MCoolFishErviceWelcome creatDelegateWithBack_MMMethodMMM:handler]
                  ...
                  arrowDirection_MMMethodMMM:(UIPopoverArrowDirection)direction
{
    ...
    else
    {
        ...
        actionSheet.delegate = [MCoolFishErviceWelcome creatDelegateWithBack_MMMethodMMM:block];
        ...
        [actionSheet showInView:[MCoolFishResponse getCurrentViewController_MMMethodMMM].view];
