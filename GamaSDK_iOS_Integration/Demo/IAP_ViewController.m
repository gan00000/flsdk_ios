...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [CHMXTTBlock getCurrentScreenFrame].size.width, [CHMXTTBlock getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
