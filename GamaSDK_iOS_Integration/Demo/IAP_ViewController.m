...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [BreviVincy getCurrentScreenFrame].size.width, [BreviVincy getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
