...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [OctavsubjectmostRepresentling getCurrentScreenFrame].size.width, [OctavsubjectmostRepresentling getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
