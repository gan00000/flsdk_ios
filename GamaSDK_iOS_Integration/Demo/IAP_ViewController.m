...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [MCoolFishResponse getCurrentScreenFrame].size.width, [MCoolFishResponse getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
