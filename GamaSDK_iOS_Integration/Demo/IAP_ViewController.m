...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [PeopleitionStudentosity getCurrentScreenFrame].size.width, [PeopleitionStudentosity getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
