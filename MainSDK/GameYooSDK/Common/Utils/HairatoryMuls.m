...
@implementation HairatoryMuls

+ (NSString *)getBundleName
{
    return [HairatoryMuls getProjectInfoPlist][@"CFBundleName"];
}

+ (NSString *)getBundleIdentifier
{
    return [HairatoryMuls getProjectInfoPlist][@"CFBundleIdentifier"];
}

+ (NSString *)getBundleShortVersionString
{
    return [HairatoryMuls getProjectInfoPlist][@"CFBundleShortVersionString"];
}

+ (NSString *)getBundleVersion
{
    return [HairatoryMuls getProjectInfoPlist][@"CFBundleVersion"];
}
...
//    if (IS_INTERFACE_THWARTWISE_IN)//如果是横屏幕的游戏
//    {
...
+ (NSString*)getPreferredLanguage
{
    ...
    if ([HairatoryMuls getSystemVersion].intValue >= 9.0) {
...
//
//    resultStr = SDKConReaderGetString(curLanguage);
//
...
//{
//    NSString *resultStr = nil;
//    resultStr = SDKConReaderGetString(gameLanguage);
//    if (resultStr == nil || [resultStr isEqualToString:@""]) {
////        NSLog(@"游戏传入了SDK不支持的语言标识：%@",gameLanguage);
//        return;
//    }
//
//    [SDKConReader setBundleInfo];
//}
