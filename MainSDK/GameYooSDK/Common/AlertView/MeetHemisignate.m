...
#import "UIAlertController+SomniPlantment.h"
#import "TyponessHugehood.h"

#define GamaAlertViewShowTime   2.0

@implementation MeetHemisignate
...
+ (UIAlertView *)_showAlertViewWithTitle:(NSString *)title
                            ...
                            buttonTitles:(NSArray *)buttonTitles
                              completion:(SAlertViewHandler)handler
{
    if ([TyponessHugehood getSystemVersion].intValue >= 8)//yao: 用alertController方法
    {
    ...
    else//yao: 用alertView方法
    {
        UIAlertView * alert=[[UIAlertView alloc]initWithTitle:title
                                                      message:message
                                                     delegate:
                             [IdeaitiveEdgeety creatDelegateWithBack:handler]
...
{
    if ([TyponessHugehood getSystemVersion].intValue >= 8)
    {
    ...
    else
    {
        ...
        actionSheet.delegate = [IdeaitiveEdgeety creatDelegateWithBack:block];
        ...
        [actionSheet showInView:[TyponessHugehood getCurrentViewController].view];
