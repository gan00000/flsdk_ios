...
@implementation RangeionHer

//手机区号获取
+(void)getAreaInfoWithSuccessBlock:(BJServiceSuccessBlock)successBlock
                                errorBlock:(BJServiceErrorBlock)errorBlock
{
    VectAwayose *configHTTPEngine = [[VectAwayose alloc] initWithBasePath:[SDKRES getCdnUrl]];
    [configHTTPEngine getRequestWithFunctionPath:[NSString stringWithFormat:@"sdk/config/areaCode/areaInfo.json?t=%@", [TyponessHugehood getTimeStamp]] params:nil successBlock:^(NSURLSessionDataTask *task, id responseData) {
        
        NSArray *responseArray = responseData;
        SDK_LOG(@"sdk areaCode info:%@",responseArray);
        if (responseArray) {
            [GenuosityFirst savePhoneAreaInfo:responseArray];
        }
...
{
    VectAwayose *configHTTPEngine = [[VectAwayose alloc] initWithBasePath:[SDKRES getCdnUrl]];
    [configHTTPEngine getRequestWithFunctionPath:[NSString stringWithFormat:@"sdk/config/%@/v1/version.json?t=%@", GAME_CODE, [TyponessHugehood getTimeStamp]] params:nil successBlock:^(NSURLSessionDataTask *task, id responseData) {
        ...
        if (mCr) {
            ...
            if (mCr.subVersion){
                ...
                for (ConfigModel *cm in mCr.subVersion) {
                    ...
                    if ([cm.version isEqualToString:[TyponessHugehood getBundleVersion]] && [cm.packageName isEqualToString:[TyponessHugehood getBundleIdentifier]]) {//匹配子版本开关
            ...
            if (mCr.allVersion && [mCr.allVersion.packageName isEqualToString:[TyponessHugehood getBundleIdentifier]]) {//先匹配所有版本开关
             ...
             errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    //获取时间戳
    NSString * timeStamp=[TyponessHugehood getTimeStamp];
...
//    isGuestLogin ? : [md5str appendFormat:@"%@",thirdPlate];
    NSString * md5SignStr=[TyponessHugehood getMD5StrFromString:md5str];
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:requestUrlPath params:params successBlock:successBlock errorBlock:errorBlock];
}
...
//    [md5str appendFormat:@"%@",[[GamaFunction getMD5StrFromString:password] lowercaseString]]; //用户密码
    ...
    @try {
        dic = @{
            ...
            @"gameCode"         :[NSString stringWithFormat:@"%@",GAME_CODE],
            @"loginId"             :userName,
            @"password"              :[[TyponessHugehood getMD5StrFromString:password] lowercaseString],
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_login_account params:params successBlock:successBlock errorBlock:errorBlock];
}
                                  ...
                                  errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [BrothersionDipsodeath postRequestWithFunctionPath:api_get_vfCode params:params successBlock:successBlock errorBlock:errorBlock];
...
//    NSString * md5SignStr=[TyponessHugehood getMD5StrFromString:md5str];
    ...
    [params addEntriesFromDictionary:dic];
    [BrothersionDipsodeath postRequestWithFunctionPath:api_sendMobileVcode params:params successBlock:successBlock errorBlock:errorBlock];
                                  ...
                                  errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    [params addEntriesFromDictionary:dic];
    [BrothersionDipsodeath postRequestWithFunctionPath:api_bind_phone params:params successBlock:successBlock errorBlock:errorBlock];
...
+ (NSDictionary *)appendCommParamsDic
{
    ...
    @{
        // 公共的参数拼接
        @"packageName"      :     [TyponessHugehood getBundleIdentifier],
        @"adId"             :     [[TyponessHugehood getIdfa]       lowercaseString]? : @"",
        @"idfa"             :     [[TyponessHugehood getIdfa]       lowercaseString]? : @"",
        @"uuid"             :     [[TyponessHugehood getGamaUUID]     lowercaseString]? : @"",
        @"versionName"      :     [TyponessHugehood getBundleShortVersionString]? : @"",
        @"versionCode"      :     [TyponessHugehood getBundleVersion]? : @"",
        @"systemVersion"    :     [TyponessHugehood getSystemVersion]? : @"",
        @"deviceType"       :     [TyponessHugehood getDeviceType]? : @"",
        @"os"               :     @"ios", //os=ios
        @"gameLanguage"     :     GAME_LANGUAGE? : @"",
        @"osLanguage"       :     [TyponessHugehood getPreferredLanguage]? : @"",
...
+ (NSDictionary *)appendGameParamsDic
{
    ...
    @try {
        ...
        DorspoorencyDesdata *gameUserModel = SDK_DATA.gameUserModel;
...
//    [md5str appendFormat:@"%@",[[GamaFunction getMD5StrFromString:password] lowercaseString]]; //用户密码
    ...
    @try {
        dic = @{
            ...
            @"gameCode"         :GAME_CODE,
            @"loginId"          :userName,
            @"password"         :[TyponessHugehood getMD5StrFromString:password],
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_login_register params:params successBlock:successBlock errorBlock:errorBlock];
...
//    [md5str appendString:[[GamaFunction getMD5StrFromString:newPassword] lowercaseString]]; //新密码
    ...
    @try {
        dic = @{
            ...
            @"name"             :userName,
            @"loginId"          :userName,
            @"oldPwd"           :[[TyponessHugehood getMD5StrFromString:oldPassword] lowercaseString],
            @"newPwd"           :[[TyponessHugehood getMD5StrFromString:newPassword] lowercaseString],
            @"registPlatform"   :LOGIN_TYPE_SELF,
        };
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_change_pwd params:params successBlock:successBlock errorBlock:errorBlock];
                        ...
                        errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_forgot_pwd params:params successBlock:successBlock errorBlock:errorBlock];
...
//    [md5str appendFormat:@"%@",[thirdPlate lowercaseString]];//thirdplatform
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_bind_account params:params successBlock:successBlock errorBlock:errorBlock];
...
//    [md5str appendFormat:@"%@",[thirdPlate lowercaseString]];//thirdplatform
    ...
    [BrothersionDipsodeath postRequestWithFunctionPath:api_delete_account params:params successBlock:successBlock errorBlock:errorBlock];
...
+ (void)createOrderWithproductId:(NSString *)productId
            cpOrderId:(NSString *)cpOrderId
             ...
             gameInfo:(DorspoorencyDesdata*)gameUserModel
...
//    [md5str appendFormat:@"%@",[thirdPlate lowercaseString]];//thirdplatform
    ...
    [SimilariorCostad postRequestWithFunctionPath:api_order_create params:params successBlock:successBlock errorBlock:errorBlock];
...
//    [md5str appendFormat:@"%@",[thirdPlate lowercaseString]];//thirdplatform
    ...
    [SimilariorCostad postRequestWithFunctionPath:api_payment params:params successBlock:successBlock errorBlock:errorBlock];
