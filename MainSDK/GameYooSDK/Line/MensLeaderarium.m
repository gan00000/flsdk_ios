...
@interface MensLeaderarium() <LineSDKLoginDelegate>

@property (nonatomic) LineCallBack successCallBack;
@property (nonatomic) LineCallBack failCallBack;

@end
@implementation MensLeaderarium

+ (instancetype)share{
    
    static MensLeaderarium *mLineDelegate = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mLineDelegate = [[MensLeaderarium alloc] init];
    });
