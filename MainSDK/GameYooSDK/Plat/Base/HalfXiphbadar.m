...
//Gama_Swizzle([delegate class], @selector(__SELECTORSTRING__), class_getClassMethod([HalfXiphbadar class], GAMA_ADD_SELECTOR_PREFIX(__SELECTORSTRING__))); \
//
...
//        Method m = class_getClassMethod([HalfXiphbadar class], _efun_selector_);
...
//}
//
//@interface LaminoilfactionSoonot ()
//
//
//
//@end
...
//                                                          [HalfXiphbadar star_application:note.object didFinishLaunchingWithOptions:note.userInfo];
//                                                      });
//                                                  }];
...
//                                                  usingBlock:^(NSNotification *note) {
//                                                      dispatch_async(dispatch_get_main_queue(), ^{
//                                                          [HalfXiphbadar star_applicationDidBecomeActive:note.object];
//                                                      });
//                                                  }];
...
//                                                  usingBlock:^(NSNotification *note) {
//                                                      dispatch_async(dispatch_get_main_queue(), ^{
//                                                          [HalfXiphbadar star_applicationWillTerminate:note.object];
//                                                      });
//                                                  }];
...
//                                                  usingBlock:^(NSNotification *note) {
//                                                      dispatch_async(dispatch_get_main_queue(), ^{
//                                                          [HalfXiphbadar star_applicationDidEnterBackground:note.object];
//                                                      });
//                                                  }];
//    [[NSNotificationCenter defaultCenter] addObserverForName:UIApplicationDidEnterBackgroundNotification
//                                                      object:nil
...
//                                                  usingBlock:^(NSNotification *note) {
//                                                      dispatch_async(dispatch_get_main_queue(), ^{
//                                                          [HalfXiphbadar star_applicationWillEnterForeground:note.object];
//                                                      });
//                                                  }];
//}
//
