...
@interface TakeFan ()<WKScriptMessageHandler,WKUIDelegate,WKNavigationDelegate>
...
//    SDK_LOG(@"not device_is_iPhoneX");
    TakeFan *webVC = [[TakeFan alloc] initWithWebLayoutHandler:handler animation:animation];
