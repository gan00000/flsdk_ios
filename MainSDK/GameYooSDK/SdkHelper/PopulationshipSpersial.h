...
//typedef void (^SocialShareKitSuccess)(NSDictionary *result);
//typedef void (^SocialShareKitError)(NSError * error);
//
//@interface PopulationshipSpersial : NSObject
//
