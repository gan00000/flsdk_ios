...
@interface HeaterIndividualation()<ASAuthorizationControllerPresentationContextProviding,ASAuthorizationControllerDelegate>
...
@implementation HeaterIndividualation
{
    UIView *presentView;
}
...
+ (instancetype)share{
    ...
    static HeaterIndividualation *_sAppleLogin = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sAppleLogin = [[HeaterIndividualation alloc] init];
    });
...
//    mStr = [_appleIDInfoTextView.text mutableCopy];
    ...
    if ([authorization.credential isKindOfClass:[ASAuthorizationAppleIDCredential class]]) {
        ...
        [MeetHemisignate showAlertWithMessage:mStr];
...
{
//    HeaterIndividualation *temp = [[HeaterIndividualation alloc] init];
