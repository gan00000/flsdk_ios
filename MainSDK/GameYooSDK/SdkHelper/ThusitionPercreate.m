...
@interface ThusitionPercreate()
@property (nonatomic,assign) CGFloat viewAdaptRate;
@end

@implementation ThusitionPercreate

+ (instancetype)share{
    
    static ThusitionPercreate *_xDimeUtil = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _xDimeUtil = [[ThusitionPercreate alloc] init];
    });
