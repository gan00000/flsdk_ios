...
@implementation CollectionletOmasthing

{
    GuberntyPyr *thirdAccountSDKTextFiledView;
    GuberntyPyr *accountSDKTextFiledView;
    GuberntyPyr *pwdSDKTextFiledView;
    
    GuberntyPyr *hasBind_accountSDKTextFiledView;
...
- (instancetype)initView
{
    ...
    if (self) {
        ...
        UILabel *titleLabel = [StenRoborious initLabelWithText:@"text_update_account".localx fontSize:FS(15) textColor:[UIColor colorWithHexString:@"#2A2A2A"]];
        ...
        UIButton *closeBtn = [StenRoborious initBtnWithNormalImage:icon_close_3 highlightedImage:icon_close_3 tag:TAG_CLOSE selector:@selector(registerViewBtnAction:) target:self];
        ...
        if (currentAccount.isBind) {
            ...
            thirdAccountSDKTextFiledView = [[GuberntyPyr alloc] initViewWithType:(SDKTextFiledView_Type_Account)];
            ...
            hasBind_accountSDKTextFiledView = [[GuberntyPyr alloc] initViewWithType:(SDKTextFiledView_Type_Account)];
            ...
            //密码
            pwdSDKTextFiledView = [[GuberntyPyr alloc] initViewWithType:(SDKTextFiledView_Type_Password)];
            ...
            UILabel *bindTipLabel = [StenRoborious initLabelWithText:GetString(@"text_bind_account_tips") fontSize:FS(10) textColor:[UIColor colorWithHexString:@"#C0C0C0"]];
        ...
        //確認
        UIButton *okBtn = [StenRoborious initBtnWithTitleText:GetString(@"text_confire_update") fontSize:FS(17) textColor:[UIColor whiteColor] tag:kOkActTag selector:@selector(registerViewBtnAction:) target:self];
...
- (void)initData
{
    ...
    [SinistritionCaptexplainine makeAccountFiledViewStatus:tempAccountModel accountView:thirdAccountSDKTextFiledView pwdView:nil];
    thirdAccountSDKTextFiledView.inputUITextField.enabled = NO;
}
