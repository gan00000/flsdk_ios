...
@interface EnvironmentitudePtychid ()
@property (copy,nonatomic) void (^completer)(void);
@end

@implementation EnvironmentitudePtychid
{
...
//        make.width.mas_equalTo(self);
    ...
    UILabel *titleLabel = [StenRoborious initLabelWithText:@"text_title_notice".localx fontSize:FS(16) textColor:[UIColor whiteColor]];
...
//        make.bottom.mas_equalTo(titleView);
    ...
    UIButton *closeBtn = [StenRoborious initBtnWithNormalImage:icon_close_4 highlightedImage:icon_close_4 tag:TAG_CLOSE selector:@selector(action:) target:self];
...
//        make.center.mas_equalTo(titleView);
    ...
    UIButton *leftBtn = [StenRoborious initBtnWithNormalImage:mw_arr_left highlightedImage:mw_arr_left tag:0 selector:@selector(action:) target:nil];
    ...
    UIButton *rightBtn = [StenRoborious initBtnWithNormalImage:mw_arr_right highlightedImage:mw_arr_right tag:0 selector:@selector(action:) target:nil];
