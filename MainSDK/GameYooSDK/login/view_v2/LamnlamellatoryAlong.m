...
@interface LamnlamellatoryAlong()

@end

@implementation LamnlamellatoryAlong
{
...
//        make.height.mas_equalTo(VH(40));
    ...
    loginTabBtn = [StenRoborious initBtnWithTitleText:@"text_login".localx fontSize:FS(24) textColor:UIColor.whiteColor tag:kLoginTabActTag selector:@selector(registerViewBtnAction:) target:self];
...
//        make.trailing.mas_equalTo(tabView).multipliedBy(0.5);
    ...
    regTabBtn = [StenRoborious initBtnWithTitleText:@"text_register".localx fontSize:FS(24) textColor:UIColor.whiteColor tag:kRegTabActTag selector:@selector(registerViewBtnAction:) target:self];
...
//        make.centerX.mas_equalTo(regTabBtn);
    ...
    //返回按钮
    backBtn = [StenRoborious initBtnWithNormalImage:mw_back_icon highlightedImage:mw_back_icon tag:kBackBtnActTag selector:@selector(registerViewBtnAction:) target:self];
...
//    regTabBtn.backgroundColor = [UIColor whiteColor];
    ...
    self.mAccountLoginView = [[SectAurless alloc] initView];
    ...
    self.mRegisterAccountView = [[StationVicesimular alloc] initView];
...
//                NSArray<AccountModel *> *ams = [[UsBag share] getAccountModels];
//
//                if (ams && ams.count > 0) {
//
