...
@interface LevelyLotarian()

@end

@implementation LevelyLotarian
{
...
//    SDK_DATA.mConfigModel.showLogo = YES;
    ...
    UIImageView *logoIV = [StenRoborious initImageViewWithImage:mw_logo];
    logoIV.hidden = YES;
...
//        make.top.mas_equalTo(self.mas_top).mas_offset(hx);
    ...
    //游客登录
    guestLoginBtn = [StenRoborious initBtnWithTitleText:@"" fontSize:FS(17) textColor:[UIColor whiteColor] tag:guestLoginActTag selector:@selector(registerViewBtnAction:) target:self];
...
//        make.top.mas_equalTo(otherLoginLabel.mas_bottom).mas_offset(VH(24));
    ...
    UIButton *guestIconBtn = [StenRoborious initBtnWithNormalImage:guse_login_bg highlightedImage:nil tag:guestLoginActTag selector:@selector(registerViewBtnAction:) target:self];
    ...
    UIButton *guestTextBtn = [StenRoborious initBtnWithTitleText:@"guest_login_btn".localx fontSize:FS(17) textColor:[UIColor whiteColor] tag:guestLoginActTag selector:@selector(registerViewBtnAction:) target:self];
    ...
    UILabel *hasAccountLabel = [StenRoborious initLabelWithText:@"tips_have_account".localx fontSize:FS(12) textColor:[UIColor whiteColor]];
...
//        make.top.mas_equalTo(guestLoginBtn.mas_bottom).mas_offset(VH(15));
    ...
    UILabel *loginLabel = [StenRoborious initLabelWithText:@"text_login".localx fontSize:FS(12) textColor:[UIColor colorWithHexString:BaseColor]];
    ...
    UILabel *otherLoginLabel = [StenRoborious initLabelWithText:@"text_login_other".localx fontSize:FS(11) textColor:[UIColor colorWithHexString:@"#C0C0C0"]];
    ...
    if (SDK_DATA.mConfigModel.appPassCheck) {
        loginBtnDatas = [GenuosityFirst getShowBtnDatas:SDK_DATA.mConfigModel appleBtn:YES guestBtn:NO];
    }else{
        loginBtnDatas = [GenuosityFirst getShowBtnDatas:SDK_DATA.mConfigModel appleBtn:NO guestBtn:NO];
    }
...
//        make.top.mas_equalTo(loginTypeView.mas_bottom).mas_offset(VH(25));
    ...
    NSString *temptext = GetString(@"sdk_terms_title");
        ...
        UILabel *rememberTermsLable = [StenRoborious initLabelWithText:xtext fontSize:FS(10) textColor:[UIColor colorWithHexString:@"#C0C0C0"]];
