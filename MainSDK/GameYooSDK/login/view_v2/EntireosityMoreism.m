...
@interface EntireosityMoreism ()
@property (copy,nonatomic) void (^completer)(void);
@end

@implementation EntireosityMoreism
{
...
//        make.top.mas_equalTo(titleView);
    ...
    UILabel *titleLabel = [StenRoborious initLabelWithText:@"sdk_terms_title".localx fontSize:FS(15) textColor:[UIColor colorWithHexString:@"#2A2A2A"]];
...
//        make.center.mas_equalTo(titleView);
    ...
    UIButton *closeBtn = [StenRoborious initBtnWithTitleText:@"text_close".localx fontSize:FS(15) textColor:[UIColor colorWithHexString:BaseColor] tag:TAG_CLOSE selector:@selector(action:) target:self];
...
//        make.center.mas_equalTo(titleView);
    ...
    UIButton *okBtn = [StenRoborious initBtnWithTitleText:@"text_agree_read_tips".localx fontSize:FS(15) textColor:[UIColor whiteColor] tag:kAgreeTermsCheckBoxBtnTag selector:@selector(action:) target:self];
...
+ (BOOL)openProvision{
    ...
    return ![EntireosityMoreism isAgreenProvision];
}
