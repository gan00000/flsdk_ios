...
@implementation ExoateSympicking
...
//            make.width.mas_equalTo(self);
        ...
        //獲取驗證碼
        getVfCodeBtn = [StenRoborious initBtnWithTitleText:GetString(@"text_get_vfcode") fontSize:FS(14) textColor:[UIColor whiteColor] tag:kGetVfCodeActTag selector:@selector(registerViewBtnAction:) target:self];
...
//            make.width.mas_equalTo(accountSDKTextFiledView.mas_width).multipliedBy(0.65);
        ...
        //確認
        UIButton *okBtn = [StenRoborious initBtnWithTitleText:@"確  認" fontSize:FS(17) textColor:[UIColor whiteColor] tag:kOkActTag selector:@selector(registerViewBtnAction:) target:self];
...
-(void)findPassword
{
    ...
    if (![GenuosityFirst validPwd: newPwd] || ![GenuosityFirst validPwd: againPwd]) {
