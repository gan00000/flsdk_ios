...
@implementation ProductioniveMiasmine
...
- (instancetype)initView
{
    ...
    if (self) {
        ...
        //title
        mLoginTitleView = [[AboutiblePropertyible alloc] initViewWithTitle:GetString(@"text_update_account") hander:^(NSInteger) {
...
//    }
    ...
    if (![GenuosityFirst validPwd:pasword]) {
        return;
    }
    ...
    [AuousSituationic bindAccountAndRequest:self.delegate view:self account:currentAccountModel account:account pwd:pasword];
}
