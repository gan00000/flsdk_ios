...
@interface StearingMiasmat()

@end

@implementation StearingMiasmat
{
...
//        make.top.mas_equalTo(otherLoginLabel.mas_bottom).mas_offset(VH(24));
    ...
    UIButton *guestTextBtn = [StenRoborious initBtnWithTitleText:@"遊客登入" fontSize:FS(17) textColor:[UIColor whiteColor] tag:guestLoginActTag selector:@selector(registerViewBtnAction:) target:self];
    ...
    UILabel *hasAccountLabel = [StenRoborious initLabelWithText:@"已有帳號？ " fontSize:FS(12) textColor:[UIColor whiteColor]];
...
//        make.top.mas_equalTo(guestLoginBtn.mas_bottom).mas_offset(VH(15));
    ...
    UILabel *loginLabel = [StenRoborious initLabelWithText:@"登入" fontSize:FS(12) textColor:[UIColor colorWithHexString:@"#EB2E2B"]];
    ...
    UILabel *otherLoginLabel = [StenRoborious initLabelWithText:@"其他登入" fontSize:FS(11) textColor:[UIColor colorWithHexString:@"#C0C0C0"]];
