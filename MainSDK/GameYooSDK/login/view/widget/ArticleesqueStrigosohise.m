...
@implementation ArticleesqueStrigosohise
...
- (instancetype)initView
{
    ...
    if (self) {
        ...
        self.phoneModel = [[TenssureTravel alloc] init];
...
//    tipsUILabel.font = [UIFont systemFontOfSize:16];
    ...
    UIButton *dropButton = [StenRoborious initBtnWithNormalImage:sdk_list_down highlightedImage:sdk_list_down tag:222 selector:@selector(itemBtnAction:) target:self];
