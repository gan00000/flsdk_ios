...
@implementation LifeencePushity
...
- (void)addCellView{
    ...
    self.deleteAccountBtn = [StenRoborious initBtnWithNormalImage:delete_icon highlightedImage:delete_icon tag:kMoreAccountDeleteActTag selector:@selector(deleteAccontClick:) target:self];
