...
@implementation AboutiblePropertyible
...
- (instancetype)initViewWithTitle:(NSString *)title hander:(ItemViewClickHander) hander{
    ...
    _backBtn = [StenRoborious initBtnWithNormalImage:mw_back_icon highlightedImage:mw_back_icon tag:kBackBtnActTag selector:@selector(backBtnView:) target:self];
