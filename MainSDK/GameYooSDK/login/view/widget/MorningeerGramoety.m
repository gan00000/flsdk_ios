...
@implementation MorningeerGramoety
                      ...
                      target:(id)target
{
    ...
    if (self) {
        ...
        UIButton *iconBtn = [StenRoborious initBtnWithNormalImage:image highlightedImage:image tag:type selector:selector target:target];
