...
@interface PosicStigbut()<UITableViewDelegate, UITableViewDataSource>

    
@end

@implementation PosicStigbut{
...
//    }
    ...
    [_accountListTableView registerClass:[LifeencePushity class] forCellReuseIdentifier:AccountListViewCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LifeencePushity *cell = [tableView dequeueReusableCellWithIdentifier:AccountListViewCellID forIndexPath:indexPath];
...
//            [self.accountDataList removeObject:mAccountModel];
            [[UsBag share] removeAccountByUserId:mAccountModel.userId];
            
            [self.accountDataList removeAllObjects];
            [self.accountDataList addObjectsFromArray:[[UsBag share] getAccountModels]];
...
//            [[UsBag share] saveAccountModels:self.accountDataList];//保存
