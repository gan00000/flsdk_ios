                       ...
                       target:(id)target
{
    ...
    //UIButton *mButton = [StenRoborious initBtnWithNormalImage:normalImage highlightedImage:highlightedImage tag:tag selector:selector target:target];
    
//    UIButton *mButton = [StenRoborious initBtnWithNormalImage:normalImage highlightedImage:highlightedImage titleText:titleText tag:tag selector:selector target:target];
    
    UIButton *mButton = [StenRoborious initBtnWithTitleText:titleText fontSize:FS(17) textColor:[UIColor whiteColor] tag:tag selector:selector target:target];
    
//    [StenRoborious initBtnWithTitle:titleText tag:tag selector:selector target:target];
