...
If your New Year's resolution is to meditate five days each week, a plan like "I'll meditate on week 
**/
...
/**
  始与那些已经实现这一目标、可以告诉你如何做到的朋友们在一起。仅仅是和他们相处，你就会有收获，因为你会倾向于模仿他们的行为模式。
