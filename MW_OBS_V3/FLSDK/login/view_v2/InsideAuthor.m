...
//k or the latest binge-worthy television series.
//
...
/**
  und and started to grind it into the floor w 
**/
...
/**
  here is a way to dodge this fate. By setting tough goals (like a 10 pm bedtime every night) but giving yourself one or two get-out-of-jail-free cards each week, you can get better results than by se 
**/
    ChoiceaireIrible *accountSDKTextFiledView;
    ChoiceaireIrible *newPwdSDKTextFiledView;
    ChoiceaireIrible *vfCodeFiledView;
...
正如出场提示告诉百老汇明星何时登台一样，研究表明，在你的计划中加入 
**/
    int phoneCountdown;
    NSTimer *downTimer;
...
/**
  ng forward to workouts. Or only letting yourself drink a mocha latte during study sessions so there is a hook to get you to the library.
...
If you deviate at all from your New Year's resolution, your instinct may be to declare yourself a failure and throw in the 
**/
...
/**
  生活的价值不在于我们做了什么，或者我们认识谁，生活的价值在于我们是谁。”
...
//
//
//A steeper penalty than shame, however, is putting cold hard cash on the table, and there is excellent evidence that self-imposed cash penalties motivate success. You can make a bet with a friend that you'll stick to your New Yea
        [self addSubview:mLoginTitleView];
        [mLoginTitleView mas_makeConstraints:^(MASConstraintMaker *make) {

/**
   fit, you figure a punishing workout will be just the thing to produce rapid progress. If yo 
**/
            make.top.mas_equalTo(self.mas_top).mas_offset(VH(MARGIN_TOP));

/**
  ure from your workouts or study sessions, research has found you'll persist longer. And in the end, that's what often matters most to achieving a New Year's resolution.

如果锻炼或学习没有乐趣，就不太可能坚持下去。但研究发现如果你从锻炼或学习中获得乐趣，就会坚持得更久。而最终，这往往是实现新年计划的最重要因素。



One way to make pursuing a goal that normally feels like a chore more fun is to combine it with a guilty pleasure. Consider onl 
**/
...
Only for making me want t 
**/
        }];
        accountSDKTextFiledView = [[ChoiceaireIrible alloc] initViewWithType:(SDKTextFiledView_Type_Account)];
//by spending time together because you'll be inclined to conform to their patterns of behavior.
//
//花时间和高成就者在一起可以提高你自己的表现。如果你的新年愿望是跑一场马拉松或写一本书，那么明智的做法是开始与那些已经实现这一目标、可以告诉你如何做到的朋友们在一起。仅仅是和他们相
        accountSDKTextFiledView.moreAccountBtn.hidden = YES;
        [self addSubview:accountSDKTextFiledView];
        [accountSDKTextFiledView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.leading.mas_equalTo(self).mas_offset(VW(40));
//
//美国疾病控制与预防中心指出，大多数成人需要7到8小时睡眠时间才能得到充分休息。因此如果一个人每天要在早上7点起床，倒推8个小时睡眠时间应该
            make.trailing.mas_equalTo(self).mas_offset(VW(-40));
            make.height.mas_equalTo(VH(40));
            make.top.equalTo(mLoginTitleView.mas_bottom).mas_offset(VH(25));
        }];
        newPwdSDKTextFiledView = [[ChoiceaireIrible alloc] initViewWithType:(SDKTextFiledView_Type_Password_New)];
...
/**
  very night but couldn't resist staying up late one Friday to watch an extra episode of "Succession." After that, your early-to-bed plans went out the window because "what the hell," you'd already failed.
...
/**
  年计划会让你受到一些惩罚的话，这可以创造奇迹。



One easy way to do this is by telling a few people about your goal so you'll feel ashamed if they check back 
**/
...
//t decrease in value. It was still worth $20."
//
//
//
...
//
//
//“Many times in our lives, we are drop
...
尽管实现梦想的途中有时会遇到障碍，要知道这是命运对你的挑战。不是每个人都会赞成你的选择，接受这个现实，并相信自我的判断，追随那颗在你心中闪烁的明星，它会引领你踏上命运的征途。坚持不懈，你 
**/
            make.top.equalTo(getVfCodeBtn);
            make.bottom.equalTo(getVfCodeBtn);
// for bed. Production of melatonin is stopped by light -- so levels naturally fall as d
...
/**
  ower to help overcome your racing mind and allow you to fall asleep."

他说：“比如说你需要提早上床睡觉。床将能帮助你安抚纷繁的思绪，让 
**/
        UIView *vfCodeFiledView_bottom_line = [[UIView alloc] init];

/**
  l neglect an even more important part of the equation: whether you enjoy the act of goal purs 
**/
        vfCodeFiledView_bottom_line.hidden = YES;

/**
  have woken up right beside you.
...
When life offers you a dream so far beyond any of your expectations, it’s not reasonabl 
**/
            make.top.equalTo(getVfCodeBtn.mas_bottom).mas_offset(VH(30));

/**
  sses and the morning snuggling you and I shared.
...
/**
  duce rapid progress. If you want to ace a class, you assume long, distraction-free study sessions are key. But research has shown that focusing on efficiency can leave you high and dry because you'll neglect an even more important part of the equation: whether you enjoy the act of goal pursuit.
...
// the library.
//
//想要把追求一个辛苦的目标变得更有趣，方法就是把它与有罪恶感的快乐结合起来。如果
        [self addDrawRectBolck:^(NSString *msg, NSInteger m, NSDictionary *dic) {
// I still don't know if I can control my
            CAGradientLayer *glLayer = [GenetsayDextrition createGradientLayerWithRadius:VH(25)];
...
/**
  ty if you don't achieve your New Year's resolution can work wonders.
...
//
//
//“无论你肮脏或者干净,皱巴巴的或者被折磨，对周围爱你的人来说你仍然是无可替代的。我们生活的价值不在于我们做了什么，或者我们
}

/**
  iency can leave you high and dry because you'll neglect an even more important part of the equation: whether you e 
**/
...
Strangely enough, there is evidence that coaching friends with shared goals can i 
**/
}
...
/**
  nable to grieve when it comes to an end.
...
-(void)findPassword
{
    ...
    NSString *areaCode = @"";
//nt, catch the star that twinkles in your
    NSString *phoneNum = @"";
...
He proceeded to crumple the 20 dollar note up. He then asked, “Who still wants i 
**/
    if (![OdorSever validUserName:userName]) {
        return;
    }
...
/**
  ing eight hours would require a bedtime of 11 pm.
...
Why is that so important? Because lying in bed awake can form an association in your brain that can lead t 
**/
    @try {
        otherParamsDic = @{
...
//
//A well-known speaker started off his semi
        };
...
Many people view sleeping as the final thi 
**/
        [self downTime];
...
/**
  ，自我施加的金钱惩罚可以激励成功。你可以和朋友打赌，赌你会坚持新年计划。这样做的逻辑很简单。激励措施会改变我们的决定，而惩罚甚至比奖励让我们更有动力。
...
Most of us strive for efficiency w 
**/
        [LanguitudeQuasstenddom showAlertWithMessage:error.message];
    }];
}
-(void)downTime{
    phoneCountdown = 60;
//ve you till the end of time.
//就算来自不同世界，依旧爱你到地老天荒。
//Only for making me want you so badly.
//只有你才能让我如此上瘾。
//I don't have the strength to stay away from you anymore.
//我再也没有离开你的力气了。
//Your number was up the first time l 
...
//d dodge obstacles -- so if you plan to meditate during lunch, you'll be sure to decline a proffered lunch meeting.
//
...
//lass, you assume long, distraction-free study sessions are key. But research has shown that focusing on efficiency can leave you high and dry because you'll neglect an even more important part of the equation: whether you enjoy the act of goal pursuit.
//
...
-(void) resetVfCodeBtnStatue
{
    if (downTimer) {
        [downTimer invalidate];
//或者干净,皱巴巴的或者被折磨，对周围爱你的人来说你仍然是无可替代的。我们生活的价值不在于我们做了什么，或者我们认识谁，生活的价值在于我们是谁。”
//
//
//
//“You are special ——don't ever forget it.”
