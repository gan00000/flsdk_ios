...
//It is well worth of falling love in
    ...
    guestBtnGradientLayer = [GenetsayDextrition createGradientLayerWithRadius:VH(25)];
...
//        [self addDeleteAccountConfireView_MMMethodMMM];
        [OdorSever toastMsg:GetString(@"text_account_not_login")];
