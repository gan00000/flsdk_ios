...
**/
                    if ([cm.version isEqualToString:[SUtil getBundleVersion]] && [cm.packageName isEqualToString:[SUtil getBundleIdentifier]]) {
...
//“My friends, you have all learned a very valuable lesson. No matter what I did to the money, you still wanted it because it did not decrease in valu
            ...
            if (mCr.allVersion && [mCr.allVersion.packageName isEqualToString:[SUtil getBundleIdentifier]]) {
