...
@implementation YourTeno
+ (NSString *)getBundleName
{
    return [YourTeno getProjectInfoPlist][@"CFBundleName"];
}
...
{
    return [YourTeno getProjectInfoPlist][@"CFBundleIdentifier"];
...
{
    return [YourTeno getProjectInfoPlist][@"CFBundleShortVersionString"];
}
...
格兰德纳说：“ 
**/
    return [YourTeno getProjectInfoPlist][@"CFBundleVersion"];
...
//If it's not fun to exercise or study, you're unlikely to keep at it. But if you get pleasure from your workouts or study sessions, research has found you'll persist longer. And in the end, that's what often matters most to ach
    ...
    if ([YourTeno getSystemVersion].intValue >= 9.0) {
