...
@end
@implementation EtymousBecomeot
static EtymousBecomeot * configUtil;
static dispatch_once_t onceToken;
+ (EtymousBecomeot *)share
{
    dispatch_once(&onceToken,^{
        configUtil = [[EtymousBecomeot alloc] init];
    });
...
//Happily, there is a way to dodge this fate. By setting tough goals (like a 10 pm bedtime every night) but givin
    ...
    mAccountModel.lastLoginTime = [FoeniveNow getTimeStamp];
