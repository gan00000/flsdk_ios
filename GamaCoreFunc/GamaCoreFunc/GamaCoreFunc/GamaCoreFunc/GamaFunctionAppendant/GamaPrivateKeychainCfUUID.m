...
#define GAMAKEYCHAINKEY @"GAMA_UID"
...
+(void)saveCfUUID
{
    ...
    if (GAMAKEYCHAINKEY.length > 0 && cfuuidString.length > 0)
    {
        ...
        // 设置其他属性attributes
        [dic setObject:GAMAKEYCHAINKEY forKey:(id)kSecAttrAccount];
        // 添加密码 secValue 注意是object 是 NSData
        [dic setObject:[cfuuidString dataUsingEncoding:NSUTF8StringEncoding]
