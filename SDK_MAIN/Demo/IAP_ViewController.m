...
//    _iapTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [CollectionDoloroant getCurrentScreenFrame].size.width, [CollectionDoloroant getCurrentScreenFrame].size.height) style:UITableViewStylePlain];
