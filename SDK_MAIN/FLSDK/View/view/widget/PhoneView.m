...
- (instancetype)initView_MMMethodMMM
{
    ...
    if (self) {
        ...
        self.phoneModel_MMMPRO = [[PhoneInfoModel alloc] init];
...
//    tipsUILabel.font = [UIFont systemFontOfSize:16];
    ...
    self.aracCodeUILabel_MMMPRO = [[UILabel alloc] init];//区号
    ...
    self.aracCodeUILabel_MMMPRO.numberOfLines = 1; //0为多行
    ...
    self.aracCodeUILabel_MMMPRO.userInteractionEnabled = YES; // 可以理解为设置label可被点击
