...
#define SDK_DEFAULT_BUNDLE_NAME  [[HumaneerEgdayeur reader_MMMethodMMM] getSdkBundleName_MMMethodMMM]
#define SDK_BUNDLE  [[HumaneerEgdayeur reader_MMMethodMMM] getMySdkBundle_MMMethodMMM]

#import <Foundation/Foundation.h>

@interface HumaneerEgdayeur : NSObject
