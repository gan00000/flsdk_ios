...
#define GAMA_CONF_DEFAULT_KEY    wwwww_tag_wwwww_DYDY128KEY                  
#define GAMA_CONF_DEFAULT_IV     wwwww_tag_wwwww_DYDY128IV                   



@interface GamwhateverwardDendresque : NSObject
