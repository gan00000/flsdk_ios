 ...
 */
- (XCGroup*)addGroupWithPath:(NSString*)path andDisplayName:(NSString *)displayName;
...
- (void)addAnyTypeToReferenceWithName:(NSString *)name andType:(XcodeSourceFileType)type;
