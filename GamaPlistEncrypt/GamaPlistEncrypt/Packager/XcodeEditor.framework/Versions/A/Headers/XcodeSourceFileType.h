...
bool canBecomeBuildFileWithType(XcodeSourceFileType type);

XcodeMemberType getMemberTypeWithType(XcodeSourceFileType type);

@interface XcodeSourceFileTypeBridge : NSObject
+ (void)addNewSourcesTypeWithPBType:(NSString *)pbType;
+ (void)addNewResourcesTypeWithPBType:(NSString *)pbType;
@end