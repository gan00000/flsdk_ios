...
FUNCTION_NAME="GuestLogin"  #生成库文件的名字的功能描述，如Login， Ad等

DOTA_BUILD_FLODER_NAME="GamaGuestLogin_DotA" #请输入你需要生成的target名字。一定要写正确哦

#######################################################
#时间信息
CUR_TIME=`date "+ %Y-%m-%d %H:%M:%S"`
DATE=`date +%Y%m%d_%H%M%S`
OUTPUT_NAME="$PREFIX_NAME""_""Guest""_""$DATE"".a"

# Install dir will be the final output to the framework.
# The following line create it in the root folder of the current project.
# DOTA_FLODER_DIR="${SOURCE_ROOT}"/"${DOTA_BUILD_FLODER_NAME}"
