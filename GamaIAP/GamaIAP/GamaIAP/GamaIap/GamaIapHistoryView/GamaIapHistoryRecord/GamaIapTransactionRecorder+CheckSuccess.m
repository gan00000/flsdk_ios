...
@implementation GamaIapTransactionRecorder (CheckSuccess)
...
+(void)gamaServerCheckSuccessAndSendGameGolf
{
    ...
    [shouldInfoDic setObject:GAMA_IAP_RECORD_STATE_GAMA_SERVER_CHECK_SUCCESS_OVER forKey:GAMA_IAP_RECORD_KEY_BUYSTATE];
