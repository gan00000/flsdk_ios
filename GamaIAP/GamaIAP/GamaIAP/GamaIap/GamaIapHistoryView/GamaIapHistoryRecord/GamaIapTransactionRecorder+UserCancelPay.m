...
@implementation GamaIapTransactionRecorder (UserCancelPay)
...
+(void)userCancelPay
{
    ...
    [shouldInfoDic setObject:GAMA_IAP_RECORD_STATE_USER_CANCEL_PAY_OVER forKey:GAMA_IAP_RECORD_KEY_BUYSTATE];
