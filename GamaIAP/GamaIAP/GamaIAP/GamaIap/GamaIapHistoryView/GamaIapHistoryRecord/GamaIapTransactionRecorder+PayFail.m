//
//  GamaIapTransactionRecorder+PayFail.m
//  IAP反馈
//
//
//
...
@implementation GamaIapTransactionRecorder (PayFail)
...
+(void)payFailInAppStore
{
    ...
    [shouldInfoDic setObject:GAMA_IAP_RECORD_STATE_PAY_FAIL_OVER forKey:GAMA_IAP_RECORD_KEY_BUYSTATE];
    ...
    [userDefault setObject:encryptLogStr forKey:encryptOrderLogKey];
