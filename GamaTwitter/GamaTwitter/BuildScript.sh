...
FUNCTION_NAME="Twitter"  #生成库文件的名字的功能描述，如Login， Ad等

DOTA_BUILD_FLODER_NAME="GamaTwitter_DotA" #请输入你需要生成的target名字。一定要写正确哦

#######################################################
#时间信息
CUR_TIME=`date "+ %Y-%m-%d %H:%M:%S"`
DATE=`date +%Y%m%d_%H%M%S`
OUTPUT_NAME="$PREFIX_NAME""_""$FUNCTION_NAME""_""$DATE"".a"
